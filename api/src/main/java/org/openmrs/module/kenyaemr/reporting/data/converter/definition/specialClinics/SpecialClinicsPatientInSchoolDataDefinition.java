...
public class SpecialClinicsPatientInSchoolDataDefinition extends BaseDataDefinition implements EncounterDataDefinition {
     ...
     * Default Constructor
     */
    public SpecialClinicsPatientInSchoolDataDefinition() {
        super();
    }
     ...
     */
    public SpecialClinicsPatientInSchoolDataDefinition(String name) {
        super(name);
    }
