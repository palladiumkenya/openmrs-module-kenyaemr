...
import org.openmrs.module.kenyaemr.reporting.data.converter.definition.nutrition.NutritionPatientStatusForSAMorMAMDataDefinition;
 ...
 *
 */
@Handler(supports= NutritionPatientStatusForSAMorMAMDataDefinition.class, order=50)
public class NutritionPatientStatusForSAMorMAMDataEvaluator implements EncounterDataEvaluator {
