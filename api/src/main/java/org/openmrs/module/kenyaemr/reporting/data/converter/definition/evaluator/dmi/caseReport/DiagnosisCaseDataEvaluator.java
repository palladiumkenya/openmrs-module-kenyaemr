...
/**
 * Evaluates DiagnosisCaseDataDefinition
 */

@Handler(supports = DiagnosisCaseDataDefinition.class, order = 50)
public class DiagnosisCaseDataEvaluator implements VisitDataEvaluator {
