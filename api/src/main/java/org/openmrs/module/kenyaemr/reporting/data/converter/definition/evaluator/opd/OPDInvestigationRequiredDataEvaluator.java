...
import org.openmrs.module.kenyaemr.reporting.data.converter.definition.opd.OPDInvestigationRequiredDataDefinition;
...
/**
 * Evaluates Investigation Required  
 * MOH 240 Lab Register Register
 */
@Handler(supports= OPDInvestigationRequiredDataDefinition.class, order=50)
public class OPDInvestigationRequiredDataEvaluator implements ObsDataEvaluator {
    ...
    public EvaluatedObsData evaluate(ObsDataDefinition definition, EvaluationContext context) throws EvaluationException {
		...
		String qry = "select le.obs_id,\n" +
                "       coalesce(le.result_test_name, le.order_test_name)          as lab_test\n" +
                "from kenyaemr_etl.etl_laboratory_extract le\n" +
                "         left join (select ed.date_created,\n" +
                "                           ed.dx_rank,\n" +
                "                           ed.patient_id\n" +
