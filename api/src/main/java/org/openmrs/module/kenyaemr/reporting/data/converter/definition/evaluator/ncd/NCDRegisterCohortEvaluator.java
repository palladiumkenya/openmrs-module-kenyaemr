...
@Component
@Handler(supports= NCDRegisterCohortDefinition.class, order=50)
public class NCDRegisterCohortEvaluator implements EncounterQueryEvaluator {
    ...
    public EncounterQueryResult evaluate(EncounterQuery definition, EvaluationContext context) throws EvaluationException {
        NCDRegisterCohortDefinition def = (NCDRegisterCohortDefinition) definition;
