...
import org.openmrs.module.kenyaemr.reporting.data.converter.definition.art.ETLSelfVisitDateDataDefinition;
 ...
 */
@Handler(supports=ETLSelfVisitDateDataDefinition.class, order=50)
public class ETLSelfVisitDateDataEvaluator implements PersonDataEvaluator {
