...
public class IllCasesCohortDefinitionEvaluator implements VisitQueryEvaluator {
    ...
    public VisitQueryResult evaluate(VisitQuery visitQuery, EvaluationContext context) throws EvaluationException {
        ...
        String qry = "select v.visit_id from openmrs.visit v where date(v.date_started) between date(:startDate) and date(:endDate) and v.voided = 0;";
