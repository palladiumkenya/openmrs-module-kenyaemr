...
import org.openmrs.module.kenyaemr.reporting.data.converter.definition.specialClinics.SpecialClinicsPaymentMethodsDataDefinition;
...
/**
 */
@Handler(supports= SpecialClinicsPaymentMethodsDataDefinition.class, order=50)
public class SpecialClinicsPaymentMethodsDataEvaluator implements EncounterDataEvaluator {
    ...
    public EvaluatedEncounterData evaluate(EncounterDataDefinition definition, EvaluationContext context) throws EvaluationException {
        ...
        SpecialClinicsPaymentMethodsDataDefinition cohortDefinition = (SpecialClinicsPaymentMethodsDataDefinition) definition;
        String specialClinic = cohortDefinition.getSpecialClinic();

        String qry = "SELECT v.encounter_id, GROUP_CONCAT(m.name SEPARATOR ', ') AS payment_mode\n" +
