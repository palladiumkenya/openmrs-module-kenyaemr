...
public class ANCSupplimentDataEvaluator implements EncounterDataEvaluator {
    ...
    public EvaluatedEncounterData evaluate(EncounterDataDefinition definition, EvaluationContext context) throws EvaluationException {
        ...
        String qry = "select\n" +
                "   v.encounter_id, if(ps.sequence != '' and ps.sequence is not null, concat_ws(CHAR(13),v.iron_supplement, ps.sequence,''), v.iron_supplement ) service_and_sequence\n" +
                "from kenyaemr_etl.etl_mch_antenatal_visit v\n" +
                "   left join kenyaemr_etl.etl_anc_preventive_services ps on ps.encounter_id = v.encounter_id and ps.preventive_service = 104677\n" +
