    ...
    private DataSetDefinition getMoh706LabDatasetDefinition() {
     ...
     //URINALYSIS  	
       ...
       //TODO: Need concept for Amoeba
        ...
        cohortDsd.addColumn("CD4T500", "4.3 Haematology tests CD4 count < 500", ReportUtils.map(moh706IndicatorLibrary.getResultsBasedOnValueNumericQuestionBetweenLimits(HAEMATOLOGY_CD4, 0.0, 500.0), indParam),"");
		...
		cohortDsd.addColumn("ESRP", "4.9 Other Haematology Tests Erythrocyte sedimentation rate High", ReportUtils.map(moh706IndicatorLibrary.getResultsBasedOnValueNumericQuestionBetweenLimits(HAEMATOLOGY_ERYTHROCYTE_SEDIMENTATION_RATE, 100.0, 500.0), indParam),"");
       ...
       //Blood grouping
		...
		cohortDsd.addColumn("OGTTL", "2.2 BLOOD CHEMISTRY - Blood Sugar Test - Low Glucose Tolerance Total", ReportUtils.map(moh706IndicatorLibrary.getResultsBasedOnValueNumericQuestionBetweenLimits(BLOOD_CHEMISTRY_GLUCOSE_TOLERANCE, 0.0, 5.3), indParam), "");
		cohortDsd.addColumn("OGTTH", "2.2 BLOOD CHEMISTRY - Blood Sugar Test - High Glucose Tolerance Total", ReportUtils.map(moh706IndicatorLibrary.getResultsBasedOnValueNumericQuestionBetweenLimits(BLOOD_CHEMISTRY_GLUCOSE_TOLERANCE, 7.0, 30.0), indParam), "");
		...
		cohortDsd.addColumn("BCLC", "2.4 BLOOD CHEMISTRY - Renal Function Test - Low Creatine", ReportUtils.map(moh706IndicatorLibrary.getResultsBasedOnValueNumericQuestionBetweenLimits(BLOOD_CHEMISTRY_CREATININE, 0.0, 0.7), indParam), "");
		cohortDsd.addColumn("BCHC", "2.4 BLOOD CHEMISTRY - Renal Function Test - High Creatine", ReportUtils.map(moh706IndicatorLibrary.getResultsBasedOnValueNumericQuestionBetweenLimits(BLOOD_CHEMISTRY_CREATININE, 1.2, 30.0), indParam), "");
		...
		cohortDsd.addColumn("BCLU", "2.5 BLOOD CHEMISTRY -  Renal Function Test - Low Urea", ReportUtils.map(moh706IndicatorLibrary.getResultsBasedOnValueNumericQuestionBetweenLimits(BLOOD_CHEMISTRY_UREA, 0.0, 6.0), indParam), "");
		cohortDsd.addColumn("BCHU", "2.5 BLOOD CHEMISTRY -  Renal Function Test - High Urea", ReportUtils.map(moh706IndicatorLibrary.getResultsBasedOnValueNumericQuestionBetweenLimits(BLOOD_CHEMISTRY_UREA, 24.0, 40.0), indParam), "");
		...
		cohortDsd.addColumn("BCLS", "2.6 BLOOD CHEMISTRY -  Renal Function Test - Low Sodium", ReportUtils.map(moh706IndicatorLibrary.getResultsBasedOnValueNumericQuestionBetweenLimits(BLOOD_CHEMISTRY_SODIUM, 0.0, 135.0), indParam), "");
		cohortDsd.addColumn("BCHS", "2.6 BLOOD CHEMISTRY -  Renal Function Test - High Sodium", ReportUtils.map(moh706IndicatorLibrary.getResultsBasedOnValueNumericQuestionBetweenLimits(BLOOD_CHEMISTRY_SODIUM, 155.0, 400.0), indParam), "");
		...
		cohortDsd.addColumn("BCLP", "2.7 BLOOD CHEMISTRY -  Renal Function Test - Low Potassium", ReportUtils.map(moh706IndicatorLibrary.getResultsBasedOnValueNumericQuestionBetweenLimits(BLOOD_CHEMISTRY_POTASSIUM, 0.0, 3.5), indParam), "");
		cohortDsd.addColumn("BCHP", "2.7 BLOOD CHEMISTRY -  Renal Function Test - High Potassium", ReportUtils.map(moh706IndicatorLibrary.getResultsBasedOnValueNumericQuestionBetweenLimits(BLOOD_CHEMISTRY_POTASSIUM, 5.5, 30.0), indParam), "");
		...
		cohortDsd.addColumn("BCLCH", "2.8 BLOOD CHEMISTRY -  Renal Function Test - Low Chlorides", ReportUtils.map(moh706IndicatorLibrary.getResultsBasedOnValueNumericQuestionBetweenLimits(BLOOD_CHEMISTRY_CHLORIDES, 0.0, 97.0), indParam), "");
		cohortDsd.addColumn("BCHCH", "2.8 BLOOD CHEMISTRY -  Renal Function Test - High Chlorides", ReportUtils.map(moh706IndicatorLibrary.getResultsBasedOnValueNumericQuestionBetweenLimits(BLOOD_CHEMISTRY_CHLORIDES, 111.0, 200.0), indParam), "");
		...
		cohortDsd.addColumn("LFTLTB", "2.10 BLOOD CHEMISTRY -  Liver Function Test -  Low Total Bilirubin", ReportUtils.map(moh706IndicatorLibrary.getResultsBasedOnValueNumericQuestionBetweenLimits(LFT_TOTAL_BILIRUBIN, 0.0, 1.71), indParam), "");
		cohortDsd.addColumn("LFTHTB", "2.10 BLOOD CHEMISTRY -  Liver Function Test -  High Total Bilirubin", ReportUtils.map(moh706IndicatorLibrary.getResultsBasedOnValueNumericQuestionBetweenLimits(LFT_TOTAL_BILIRUBIN, 20.5, 40.0), indParam), "");
		...
		cohortDsd.addColumn("LFTLASAT", "2.11 BLOOD CHEMISTRY -  Liver Function Test - Low ASAT (SGOT)", ReportUtils.map(moh706IndicatorLibrary.getResultsBasedOnValueNumericQuestionBetweenLimits(LFT_SGOT, 0.0, 0.0), indParam), "");
		cohortDsd.addColumn("LFTHASAT", "2.11 BLOOD CHEMISTRY -  Liver Function Test - High ASAT (SGOT)", ReportUtils.map(moh706IndicatorLibrary.getResultsBasedOnValueNumericQuestionBetweenLimits(LFT_SGOT, 41.0, 100.0), indParam), "");
		...
		cohortDsd.addColumn("LFTLSGPT", "2.12 BLOOD CHEMISTRY -  Liver Function Test - Low ALAT (SGPT)", ReportUtils.map(moh706IndicatorLibrary.getResultsBasedOnValueNumericQuestionBetweenLimits(LFT_SGPT, 0.0, 0.0), indParam), "");
		cohortDsd.addColumn("LFTHSGPT", "2.12 BLOOD CHEMISTRY -  Liver Function Test - High ALAT (SGPT)", ReportUtils.map(moh706IndicatorLibrary.getResultsBasedOnValueNumericQuestionBetweenLimits(LFT_SGPT, 40.0, 100.0), indParam), "");
		...
		cohortDsd.addColumn("LFTLSP", "2.13 BLOOD CHEMISTRY -  Liver Function Test - Low Serum Protein", ReportUtils.map(moh706IndicatorLibrary.getResultsBasedOnValueNumericQuestionBetweenLimits(LFT_SERUM_PROTEIN, 0.0, 6.0), indParam), "");
		cohortDsd.addColumn("LFTHSP", "2.13 BLOOD CHEMISTRY -  Liver Function Test - High Serum Protein", ReportUtils.map(moh706IndicatorLibrary.getResultsBasedOnValueNumericQuestionBetweenLimits(LFT_SERUM_PROTEIN, 8.3, 30.0), indParam), "");
		...
		cohortDsd.addColumn("LFTLA", "2.14 BLOOD CHEMISTRY -  Liver Function Test - Low Albumin", ReportUtils.map(moh706IndicatorLibrary.getResultsBasedOnValueNumericQuestionBetweenLimits(LFT_SERUM_ALBUMIN, 0.0, 3.4), indParam), "");
		cohortDsd.addColumn("LFTHA", "2.14 BLOOD CHEMISTRY -  Liver Function Test - High Albumin", ReportUtils.map(moh706IndicatorLibrary.getResultsBasedOnValueNumericQuestionBetweenLimits(LFT_SERUM_ALBUMIN, 5.4, 30.0), indParam), "");
		...
		cohortDsd.addColumn("LFTLAP", "2.15 BLOOD CHEMISTRY -  Liver Function Test - Low Alkaline Phosphatase", ReportUtils.map(moh706IndicatorLibrary.getResultsBasedOnValueNumericQuestionBetweenLimits(LFT_ALKALINE_PHOSPHATASE, 0.0, 30.0), indParam), "");
		cohortDsd.addColumn("LFTHAP", "2.15 BLOOD CHEMISTRY -  Liver Function Test - High Alkaline Phosphatase", ReportUtils.map(moh706IndicatorLibrary.getResultsBasedOnValueNumericQuestionBetweenLimits(LFT_ALKALINE_PHOSPHATASE, 120.0, 300.0), indParam), "");
		...
		cohortDsd.addColumn("HTLT3", "2.20 BLOOD CHEMISTRY - Hormonal Test -  Low T3", ReportUtils.map(moh706IndicatorLibrary.getResultsBasedOnValueNumericQuestionBetweenLimits(HORMONAL_TEST_T3, 0.0, 3.5), indParam), "");
		cohortDsd.addColumn("HTHT3", "2.20 BLOOD CHEMISTRY - Hormonal Test -  High T3", ReportUtils.map(moh706IndicatorLibrary.getResultsBasedOnValueNumericQuestionBetweenLimits(HORMONAL_TEST_T3, 7.0, 30.0), indParam), "");
		...
		cohortDsd.addColumn("HTLT4", "2.21 BLOOD CHEMISTRY - Hormonal Test -  Low T4", ReportUtils.map(moh706IndicatorLibrary.getResultsBasedOnValueNumericQuestionBetweenLimits(HORMONAL_TEST_T4, 0.0, 10.0), indParam), "");
		cohortDsd.addColumn("HTHT4", "2.21 BLOOD CHEMISTRY - Hormonal Test -  High T4", ReportUtils.map(moh706IndicatorLibrary.getResultsBasedOnValueNumericQuestionBetweenLimits(HORMONAL_TEST_T4, 22.0, 50.0), indParam), "");
		...
		cohortDsd.addColumn("HTLTSH", "2.22 BLOOD CHEMISTRY - Hormonal Test -  Low TSH", ReportUtils.map(moh706IndicatorLibrary.getResultsBasedOnValueNumericQuestionBetweenLimits(HORMONAL_TEST_TSH, 0.0, 3.5), indParam), "");
		cohortDsd.addColumn("HTHTSH", "2.22 BLOOD CHEMISTRY - Hormonal Test -  High TSH", ReportUtils.map(moh706IndicatorLibrary.getResultsBasedOnValueNumericQuestionBetweenLimits(HORMONAL_TEST_TSH, 4.75, 30.0), indParam), "");
		...
		cohortDsd.addColumn("TMLC153", "2.25 BLOOD CHEMISTRY - Tumor Makers  -  Low C15-3", ReportUtils.map(moh706IndicatorLibrary.getResultsBasedOnValueNumericQuestionBetweenLimits(TUMOR_MARKERS_C15_3, 0.0, 0.0), indParam), "");
		cohortDsd.addColumn("TMHC153", "2.25 BLOOD CHEMISTRY - Tumor Makers  -  High C15-3", ReportUtils.map(moh706IndicatorLibrary.getResultsBasedOnValueNumericQuestionBetweenLimits(TUMOR_MARKERS_C15_3, 30.0, 100.0), indParam), "");
		...
		cohortDsd.addColumn("CSFLP", "2.26 BLOOD CHEMISTRY - CSF Chemistry -  Low Proteins", ReportUtils.map(moh706IndicatorLibrary.getResultsBasedOnValueNumericQuestionBetweenLimits(CFS_CHEMISTRY_PROTEINS, 0.0, 15.0), indParam), "");
		cohortDsd.addColumn("CSFHP", "2.26 BLOOD CHEMISTRY - CSF Chemistry -  High Proteins", ReportUtils.map(moh706IndicatorLibrary.getResultsBasedOnValueNumericQuestionBetweenLimits(CFS_CHEMISTRY_PROTEINS, 60.0, 200.0), indParam), "");
		...
		cohortDsd.addColumn("CSFLG", "2.27 BLOOD CHEMISTRY - CSF Chemistry -  Low Glucose", ReportUtils.map(moh706IndicatorLibrary.getResultsBasedOnValueNumericQuestionBetweenLimits(CFS_CHEMISTRY_GLUCOSE, 0.0, 50.0), indParam), "");
		cohortDsd.addColumn("CSFHG", "2.27 BLOOD CHEMISTRY - CSF Chemistry -  High Glucose", ReportUtils.map(moh706IndicatorLibrary.getResultsBasedOnValueNumericQuestionBetweenLimits(CFS_CHEMISTRY_GLUCOSE, 80.0, 200.0), indParam), "");
