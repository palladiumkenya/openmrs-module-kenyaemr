...
/**
 * Evaluates ANC Hepatitis B Treated Evaluator
 */
@Handler(supports= ANCHepatitisBTreatedDefinition.class, order=50)
public class ANCHepatitisBTreatedDataEvaluator implements EncounterDataEvaluator {
