...
public class Moh755ReportBuilder extends AbstractReportBuilder {
    ...
    private DataSetDefinition createOphthalmicServiceSummaryDataSet() {
        ...
        EmrReportingUtils.addRow(dsd, "Learning Disabilities", "(Dyslexia, dysgraphia, dyscalculia, auditory processing, language processing disorder, Nonverbal learning disabilities, visual perceptual or visual motor deficit)", ReportUtils.map(specialClinicsIndicators.learningFindings(SPECIAL_CLINIC), indParams), therapeuticAgeDisaggregations, Arrays.asList("01", "02", "03", "04", "05", "06", "07", "08", "09", "10", "11"));
        EmrReportingUtils.addRow(dsd, "Neurodevelopmental Disabilities", "(cerebral palsy, down syndrome, hydrocephalus, spina bifida)", ReportUtils.map(specialClinicsIndicators.neurodevelopmental(SPECIAL_CLINIC), indParams), therapeuticAgeDisaggregations, Arrays.asList("01", "02", "03", "04", "05", "06", "07", "08", "09", "10", "11"));
        EmrReportingUtils.addRow(dsd, "Neuro Diversity Conditions", "(ADHD, Autism)", ReportUtils.map(specialClinicsIndicators.neurodiversityConditions(SPECIAL_CLINIC), indParams), therapeuticAgeDisaggregations, Arrays.asList("01", "02", "03", "04", "05", "06", "07", "08", "09", "10", "11"));
        EmrReportingUtils.addRow(dsd, "Intellectual Disabilities", "", ReportUtils.map(specialClinicsIndicators.childrenWithIntellectualDisabilities(SPECIAL_CLINIC), indParams), therapeuticAgeDisaggregations, Arrays.asList("01", "02", "03", "04", "05", "06", "07", "08", "09", "10", "11"));
        EmrReportingUtils.addRow(dsd, "Delayed Developmental Milestones", "", ReportUtils.map(specialClinicsIndicators.delayedDevelopmentalMilestones(SPECIAL_CLINIC), indParams), therapeuticAgeDisaggregations, Arrays.asList("01", "02", "03", "04", "05", "06", "07", "08", "09", "10", "11"));
        EmrReportingUtils.addRow(dsd, "Trained On Assistive Technology", "", ReportUtils.map(specialClinicsIndicators.childrenTrainedOnAT(SPECIAL_CLINIC), indParams), therapeuticAgeDisaggregations, Arrays.asList("01", "02", "03", "04", "05", "06", "07", "08", "09", "10", "11"));
        return dsd;
    }
