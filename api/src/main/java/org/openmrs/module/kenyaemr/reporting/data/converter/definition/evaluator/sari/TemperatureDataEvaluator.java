 ...
 */
@Handler(supports= TemperatureDataDefinition.class, order=50)
public class TemperatureDataEvaluator implements PersonDataEvaluator {
    ...
    public EvaluatedPersonData evaluate(PersonDataDefinition definition, EvaluationContext context) throws EvaluationException {
        ...
        String qry = "select t.patient_id,\n" +
                "          mid(max(concat(t.visit_date,t.temperature)),11) as temperature from kenyaemr_etl.etl_patient_triage t \n" +
