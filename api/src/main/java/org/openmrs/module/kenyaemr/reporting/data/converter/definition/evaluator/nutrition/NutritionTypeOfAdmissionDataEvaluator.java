...
import org.openmrs.module.kenyaemr.reporting.data.converter.definition.nutrition.NutritionTypeOfAdmissionDataDefinition;
 ...
 *
 */
@Handler(supports= NutritionTypeOfAdmissionDataDefinition.class, order=50)
public class NutritionTypeOfAdmissionDataEvaluator implements EncounterDataEvaluator {
