...
import org.openmrs.module.kenyaemr.reporting.data.converter.definition.PopulationTypeActiveDataDefinition;
...
public class ActivePatientSnapshotReportBuilder extends AbstractHybridReportBuilder {
    ...
    protected PatientDataSetDefinition activePatientsDataSetDefinition(String datasetName) {
        ...
        dsd.addColumn("Population Type", new PopulationTypeActiveDataDefinition(), "");
