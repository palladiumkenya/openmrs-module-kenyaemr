...
@Handler(supports = VitalsTempCollectionModeDataDefinition.class, order = 50)
public class VitalsTempCollectionModeDataEvaluator implements VisitDataEvaluator {
    ...
    public EvaluatedVisitData evaluate(VisitDataDefinition definition, EvaluationContext context) throws EvaluationException {
        ...
        String qry = "select t.visit_id,case t.temperature_collection_mode when 5112 then 'Axiliary' when 166242 then 'Forehead thermometer gun' when 160240 then 'Oral' end as temp_collection_mode\n" +
