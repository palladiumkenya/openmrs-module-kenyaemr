...
public class SpecialCoexialMedicalConditionDataDefinition extends BaseDataDefinition implements EncounterDataDefinition {
     ...
     * Default Constructor
     */
    public SpecialCoexialMedicalConditionDataDefinition() {
        super();
    }
     ...
     */
    public SpecialCoexialMedicalConditionDataDefinition(String name) {
        super(name);
    }
