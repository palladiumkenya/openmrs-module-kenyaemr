...
public class SpecialClinicsWeightDataDefinition extends BaseDataDefinition implements EncounterDataDefinition {
     ...
     * Default Constructor
     */
    public SpecialClinicsWeightDataDefinition() {
        super();
    }
     ...
     */
    public SpecialClinicsWeightDataDefinition(String name) {
        super(name);
    }
