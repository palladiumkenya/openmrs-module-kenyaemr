...
/**
 */
@Handler(supports= SpecialClinicsMUACDataDefinition.class, order=50)
public class SpecialClinicsMUACDataEvaluator implements EncounterDataEvaluator {
    ...
    public EvaluatedEncounterData evaluate(EncounterDataDefinition definition, EvaluationContext context) throws EvaluationException {
        ...
        SpecialClinicsMUACDataDefinition cohortDefinition = (SpecialClinicsMUACDataDefinition) definition;
        String specialClinic = cohortDefinition.getSpecialClinic();

        String qry = "select c.encounter_id, t.muac\n" +
