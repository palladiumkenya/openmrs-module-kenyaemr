...
public class SpecialClinicsOTInterventionDataDefinition extends BaseDataDefinition implements EncounterDataDefinition {
     ...
     * Default Constructor
     */
    public SpecialClinicsOTInterventionDataDefinition() {
        super();
    }
     ...
     */
    public SpecialClinicsOTInterventionDataDefinition(String name) {
        super(name);
    }
