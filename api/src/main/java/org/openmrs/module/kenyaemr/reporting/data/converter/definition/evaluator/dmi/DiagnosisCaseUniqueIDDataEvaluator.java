...
@Handler(supports= DiagnosisCaseUniqueIdDataDefinition.class, order=50)
public class DiagnosisCaseUniqueIDDataEvaluator implements EncounterDataEvaluator {
    ...
    public EvaluatedEncounterData evaluate(EncounterDataDefinition definition, EvaluationContext context) throws EvaluationException {
        ...
        String qry = "select le.encounter_id,le.visit_id as visit_id\n" +
