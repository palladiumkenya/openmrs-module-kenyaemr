...
public class SpecialClinicsPatientOnARVsDataDefinition extends BaseDataDefinition implements EncounterDataDefinition {
     ...
     * Default Constructor
     */
    public SpecialClinicsPatientOnARVsDataDefinition() {
        super();
    }
     ...
     */
    public SpecialClinicsPatientOnARVsDataDefinition(String name) {
        super(name);
    }
