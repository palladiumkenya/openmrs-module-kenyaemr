...
@Handler(supports = VitalsRespiratoryRateDataDefinition.class, order = 50)
public class VitalsRespiratoryRateDataEvaluator implements VisitDataEvaluator {
    ...
    public EvaluatedVisitData evaluate(VisitDataDefinition definition, EvaluationContext context) throws EvaluationException {
        ...
        String qry = "select t.visit_id,t.respiratory_rate\n" +
