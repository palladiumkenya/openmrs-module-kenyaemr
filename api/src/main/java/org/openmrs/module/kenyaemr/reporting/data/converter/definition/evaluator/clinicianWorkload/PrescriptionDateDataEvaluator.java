 ...
 */
@Handler(supports = PrescriptionDateDataDefinition.class, order = 50)
public class PrescriptionDateDataEvaluator implements PersonDataEvaluator {
    ...
    public EvaluatedPersonData evaluate(PersonDataDefinition definition, EvaluationContext context) throws EvaluationException {
        ...
        String qry = "WITH filtered_patients AS (\n" +
                ...
                "SELECT\n" +
                "   v.patient_id,\n" +
                "    IFNULL(p.prescription_date,'Not Done') AS prescription_date\n" +
                "FROM checked_in v\n" +
