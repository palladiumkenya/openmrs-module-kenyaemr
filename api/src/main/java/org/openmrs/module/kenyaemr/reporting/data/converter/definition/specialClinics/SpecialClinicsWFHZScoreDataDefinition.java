...
public class SpecialClinicsWFHZScoreDataDefinition extends BaseDataDefinition implements EncounterDataDefinition {
     ...
     * Default Constructor
     */
    public SpecialClinicsWFHZScoreDataDefinition() {
        super();
    }
     ...
     */
    public SpecialClinicsWFHZScoreDataDefinition(String name) {
        super(name);
    }
