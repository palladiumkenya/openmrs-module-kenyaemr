...
public class ETLPredictionCategoryDataEvaluator implements PersonDataEvaluator {
    ...
    public EvaluatedPersonData evaluate(PersonDataDefinition definition, EvaluationContext context) throws EvaluationException {
        ...
        String qry = "SELECT patient_id, hts_risk_category FROM kenyaemr_datatools.hts_eligibility_screening where date(visit_date) <= date(:endDate) GROUP BY patient_id;";
