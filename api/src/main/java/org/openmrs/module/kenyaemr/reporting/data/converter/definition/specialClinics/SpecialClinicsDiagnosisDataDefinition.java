...
public class SpecialClinicsDiagnosisDataDefinition extends BaseDataDefinition implements EncounterDataDefinition {
     ...
     * Default Constructor
     */
    public SpecialClinicsDiagnosisDataDefinition() {
        super();
    }
     ...
     */
    public SpecialClinicsDiagnosisDataDefinition(String name) {
        super(name);
    }
