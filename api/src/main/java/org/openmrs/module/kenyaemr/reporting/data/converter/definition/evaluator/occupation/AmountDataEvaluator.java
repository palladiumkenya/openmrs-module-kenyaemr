...
import org.openmrs.module.kenyaemr.reporting.data.converter.definition.occupation.AmountDataDefinition;
...
/**
 */
@Handler(supports= AmountDataDefinition.class, order=50)
public class AmountDataEvaluator implements EncounterDataEvaluator {
