...
import org.openmrs.module.kenyaemr.reporting.data.converter.definition.nutrition.NutritionPatientOnARVsDataDefinition;
 ...
 *
 */
@Handler(supports= NutritionPatientOnARVsDataDefinition.class, order=50)
public class NutritionPatientOnARVsDataEvaluator implements EncounterDataEvaluator {
