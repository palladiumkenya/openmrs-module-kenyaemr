...
public class PNCNVPAndAZTForBabyGreaterThan6WeeksDataEvaluator implements EncounterDataEvaluator {
    ...
    public EvaluatedEncounterData evaluate(EncounterDataDefinition definition, EvaluationContext context) throws EvaluationException {
        ...
        String qry = "select v.encounter_id,\n" +
                "       (case\n" +
                "            when v.infant_prophylaxis_timing = 1066 and (v.baby_nvp_dispensed = 80586 or v.baby_azt_dispensed = 160123)\n" +
                "                then 'Y'\n" +
                "            when v.infant_prophylaxis_timing = 1066 and (v.baby_nvp_dispensed = 1066 or v.baby_azt_dispensed = 1066)\n" +
                "                then 'N'\n" +
                "            when v.infant_prophylaxis_timing = 1066 and (v.baby_nvp_dispensed = 164142 or v.baby_azt_dispensed = 164142)\n" +
                "                then 'R'\n" +
