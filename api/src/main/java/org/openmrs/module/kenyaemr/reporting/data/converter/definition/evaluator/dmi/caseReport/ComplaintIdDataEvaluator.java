...
@Handler(supports = ComplaintIdDataDefinition.class, order = 50)
public class ComplaintIdDataEvaluator implements VisitDataEvaluator {
    ...
    public EvaluatedVisitData evaluate(VisitDataDefinition definition, EvaluationContext context) throws EvaluationException {
        ...
        String qry = "select i.visit_id,\n" +
                "       GROUP_CONCAT(DISTINCT i.complaint) as complaint\n" +
