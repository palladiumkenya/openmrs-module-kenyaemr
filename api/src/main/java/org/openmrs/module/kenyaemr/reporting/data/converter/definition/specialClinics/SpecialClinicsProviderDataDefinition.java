...
public class SpecialClinicsProviderDataDefinition extends BaseDataDefinition implements EncounterDataDefinition {
     ...
     * Default Constructor
     */
    public SpecialClinicsProviderDataDefinition() {
        super();
    }
     ...
     */
    public SpecialClinicsProviderDataDefinition(String name) {
        super(name);
    }
