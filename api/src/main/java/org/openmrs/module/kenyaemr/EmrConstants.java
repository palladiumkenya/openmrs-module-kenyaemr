...
public class EmrConstants {
	...
	// Casts Fixed
	public static final String CAST_APPLICATION = "2001627";
	public static final String HIP_SPICA_APPLICATION = "2001903";
	public static final String APPLICATION_OF_DYNACAST = "2002085";
	public static final String POP_APPLICATION_PEADS_LONG_LENGTH = "2002087";
	public static final String POP_APPLICATION_LONG_LENGTH_ADULTS = "2002088";
	public static final String POP_APPLICATION_BELOW_KNEE_ADULT = "2002089";
	public static final String POP_APPLICATION_ARM = "2002090";
	public static final String POP_APPLICATION_PEADS_BELOW_KNEE = "2002091";
	public static final String POP_APPLICATION_PAEDS = "2002092";
	public static final String POP_APPLICATION = "2002095";

	// Tractions Fixed
	public static final String APPLICATION_OF_SKULL_CALIPERS = "2001767";
	public static final String SKIN_TRACTION_APPLICATION = "2001924";
	public static final String ELECTRONIC_TRACTION = "2002023";
	public static final String TRACTION_INTERMITTENT_CONTINOUS = "2002024";
	public static final String LUMBAR_CERVICAL_TRACTION = "2002029";
	public static final String SKELETAL_TRACTION = "166753";

	// Closed Reductions
	public static final String CLOSED_REDUCTION_OF_DISLOCATION_OF_HIP = "161691";
	public static final String CLOSED_REDUCTION_OF_DISLOCATION_OF_PATELLA = "161694";
	public static final String CLOSED_REDUCTION_OF_FRACTURE_OF_PROXIMAL_HUMERUS = "161950";
	public static final String CLOSED_REDUCTION_OF_DISLOCATION_OF_SHOULDER = "161952";
	public static final String MANIPULATION_OF_SHOULDER_JOINT_UNDER_ANESTHESIA = "161953";
	public static final String MANIPULATION_OF_ELBOW_JOINT_UNDER_ANESTHESIA = "161954";
	public static final String CLOSED_REDUCTION_OF_FRACTURE_OF_SHAFT_OF_HUMERUS = "161956";
	public static final String CLOSED_REDUCTION_OF_FRACTURE_OF_SHAFT_OF_HUMERUS_WITH_INTRAMEDULLARY_FIXATION = "161958";
	public static final String CLOSED_REDUCTION_OF_SUPRACONDYLAR_FRACTURE_OF_HUMERUS = "161959";
	public static final String CLOSED_REDUCTION_OF_FRACTURE_OF_MEDIAL_EPICONDYLE_OF_HUMERUS_WITH_PERCUTANEOUS_FIXATION = "161961";
	public static final String CLOSED_REDUCTION_OF_FRACTURE_OF_LATERAL_EPICONDYLE_OF_HUMERUS_WITH_PERCUTANEOUS_FIXATION = "161962";
	public static final String CLOSED_REDUCTION_OF_DISLOCATION_OF_ELBOW = "161964";
	public static final String CLOSED_REDUCTION_OF_FRACTURE_OF_PROXIMAL_RADIUS = "161966";
	public static final String CLOSED_REDUCTION_OF_FRACTURE_OF_PROXIMAL_ULNA = "161968";
	public static final String CLOSED_REDUCTION_OF_FRACTURE_OF_SHAFT_OF_RADIUS = "161972";
	public static final String CLOSED_REDUCTION_OF_FRACTURE_OF_SHAFT_OF_ULNA = "161974";
	public static final String CLOSED_REDUCTION_OF_FRACTURE_OF_DISTAL_RADIUS = "161976";
	public static final String CLOSED_REDUCTION_OF_FRACTURE_OF_DISTAL_RADIUS_WITH_PERCUTANEOUS_FIXATION = "161977";
	public static final String CLOSED_REDUCTION_OF_DISLOCATION_OF_WRIST = "161981";
	public static final String CLOSED_REDUCTION_OF_FRACTURE_OF_METACARPAL = "161990";
	public static final String CLOSED_REDUCTION_OF_THUMB_CARPOMETACARPAL_DISLOCATION = "161992";
	public static final String CLOSED_REDUCTION_OF_METACARPOPHALANGEAL_DISLOCATION = "161993";
	public static final String CLOSED_REDUCTION_OF_FRACTURE_OF_PHALANX_OF_HAND = "161995";
	public static final String CLOSED_REDUCTION_OF_FRACTURE_OF_PHALANX_OF_HAND_WITH_PERCUTANEOUS_FIXATION = "161997";
	public static final String CLOSED_REDUCTION_OF_INTERPHALANGEAL_DISLOCATION = "161998";
	public static final String CLOSED_REDUCTION_OF_INTRACAPSULAR_FRACTURE_OF_NECK_OF_FEMUR = "162002";
	public static final String CLOSED_REDUCTION_OF_EXTRACAPSULAR_FRACTURE_OF_NECK_OF_FEMUR = "162004";
	public static final String CLOSED_REDUCTION_OF_FRACTURE_OF_SHAFT_OF_FEMUR = "162010";
	public static final String CLOSED_REDUCTION_OF_SUPRACONDYLAR_FRACTURE_OF_FEMUR = "162011";
	public static final String CLOSED_REDUCTION_OF_FRACTURE_OF_DISTAL_FEMUR_CONDYLE = "162015";
	public static final String CLOSED_REDUCTION_OF_FRACTURE_OF_DISTAL_FEMUR_CONDYLE_WITH_PERCUTANEOUS_FIXATION = "162016";
	public static final String CLOSED_REDUCTION_OF_FRACTURE_OF_PROXIMAL_TIBIA = "162020";
	public static final String CLOSED_REDUCTION_OF_DISLOCATION_OF_KNEE = "162023";
	public static final String MANIPULATION_OF_KNEE_JOINT_UNDER_ANESTHESIA = "162024";
	public static final String CLOSED_REDUCTION_OF_FRACTURE_OF_SHAFT_OF_TIBIA = "162026";
	public static final String CLOSED_REDUCTION_OF_FRACTURE_OF_MEDIAL_MALLEOLUS = "162030";
	public static final String CLOSED_REDUCTION_OF_FRACTURE_OF_POSTERIOR_MALLEOLUS = "162032";
	public static final String CLOSED_REDUCTION_OF_FRACTURE_OF_SHAFT_OF_FIBULA = "162033";
	public static final String CLOSED_REDUCTION_OF_FRACTURE_OF_DISTAL_FIBULA_LATERAL_MALLEOLUS = "162035";
	public static final String CLOSED_REDUCTION_OF_BIMALLEOLAR_ANKLE_FRACTURE = "162037";
	public static final String CLOSED_REDUCTION_OF_DISLOCATION_OF_ANKLE = "162040";
	public static final String CLOSED_REDUCTION_OF_FRACTURE_OF_BONE_AND_INTERNAL_FIXATION_USING_BONE_PLATE = "166910";
	public static final String CLOSED_REDUCTION_OF_FRACTURE_OF_BONE_AND_INTERNAL_FIXATION_USING_SCREW = "166912";
	public static final String CLOSED_REDUCTION_OF_FRACTURE_OF_BONE_AND_INTERNAL_FIXATION_USING_WIRE = "166914";
	public static final String MANIPULATION_OF_JOINT = "168694";
	public static final String DISLOCATION_REDUCTION = "1000244";
	public static final String TMJ_REDUCTION = "1000343";
	public static final String CARPAL_BONE_FRACTURE_CLOSED_OR_OPEN_OPEN_REDUCTION = "2001718";
	public static final String METACARPAL_FRACTURE_CLOSED_OR_OPEN_OPEN_REDUCTION_WITH_WITHOUT_SKELETAL_FIXATION = "2001720";
	public static final String PHALANGEAL_FRACTURE_CLOSED_OR_OPEN_OPEN_REDUCTION_WITH_WITHOUT_SKELETAL_FIXATION = "2001721";
	public static final String HIP_DISLOCATION_CLOSED_OR_OPEN_OPEN_REDUCTION = "2001723";
	public static final String TIBIA_FIBULA_BIMALLEOLAR_FRACTURE_CLOSED_WITH_MANIPULATIVE_REDUCTION = "2001730";
	public static final String ANKLE_DISLOCATION_CLOSED_OR_OPEN_OPEN_REDUCTION = "2001878";
	public static final String MANIPULATION_UNDER_ANAESTHESIA_MUA = "2002093";

	// Cast Removal
	public static final String REMOVAL_OF_POP = "2002086";
	public static final String REMOVAL_OF_DYNACAST = "2002086";

	// Traction Removal
	public static final String SKIN_TRACTION_REMOVAL = "2001931";
	public static final String SKELETAL_TRACTION_REMOVAL = "2001932";

	//Removal of Ex-fixator
	public static final String REMOVAL_OF_EXTERNAL_FIXATION = "161682";
	public static final String EXTERNAL_FIXATION_IMPLANT_REMOVAL  = "2001923";
	public static final String EXTERNAL_FIXATION_REMOVAL_MINOR_THEATRE = "2002268";
}
