...
public class EmrConstants {
	...
	public static final String XRAY_OF_ABDOMEN_2_VIEWS_AP_SUPINE_AND_LATERAL_DECUBITUS_ = "161264";
	...
	public static final String plainXRayList = String.join(",",new ArrayList<>(Arrays.asList(
			...
			XRAY_PELVIS,
			XRAY_SHOULDER,
			XRAY_UPPER_GASTROINTESTINAL_SERIES,
			DUAL_ENERGY_XRAY_PHOTON_ABSORPTIOMETRY,
			DIAGNOSTIC_RADIOGRAPHY_OF_CHEST_COMBINED_PA_AND_LATERAL,
			XRAY_OF_ABDOMEN_1_VIEW,
			XRAY_OF_ABDOMEN_2_VIEWS_AP_SUPINE_AND_LATERAL_DECUBITUS_,
			XRAY_OF_BILATERAL_ACROMIOCLAVICULAR_JOINTS,
			XRAY_OF_LEFT_ANKLE_2_VIEWS,
			XRAY_OF_RIGHT_ANKLE_2_VIEWS,
			XRAY_OF_BILATERAL_ANKLES_2_VIEWS,
			XRAY_OF_LEFT_CALCANEUS_2_VIEWS,
			XRAY_OF_RIGHT_CALCANEUS_2_VIEWS,
			XRAY_OF_BILATERAL_CALCANEUS_2_VIEWS,
			XRAY_OF_CHEST_4_VIEWS_PA_LAT_WITH_RIGHT_AND_LEFT_OBLIQUE,
			XRAY_OF_CHEST_1_VIEW_AP,
			XRAY_OF_CHEST_BILATERAL_OBLIQUE,
			XRAY_OF_CHEST_2_VIEWS_AND_APICAL_LORDOTIC,
			XRAY_OF_CHEST_APICAL_LORDOTIC,
			XRAY_OF_CHEST_4_VIEWS,
			XRAY_OF_LEFT_CLAVICLE_2_VIEWS,
			XRAY_OF_RIGHT_CLAVICLE_2_VIEWS,
			XRAY_OF_BILATERAL_CLAVICLES_2_VIEWS,
			XRAY_OF_CERVICAL_SPINE_2_OR_3_VIEWS,
			XRAY_OF_LEFT_ELBOW_2_VIEWS,
			XRAY_OF_RIGHT_ELBOW_2_VIEWS,
			XRAY_OF_BILATERAL_ELBOWS_2_VIEWS,
			XRAY_OF_FACIAL_BONES_3_VIEWS,
			XRAY_OF_LEFT_FEMUR_2_VIEWS,
			XRAY_OF_RIGHT_FEMUR_2_VIEWS,
			XRAY_OF_BILATERAL_FEMURS_2_VIEWS,
			XRAY_OF_RIGHT_WRIST_2_VIEWS,
			XRAY_OF_LEFT_WRIST_2_VIEWS,
			XRAY_OF_THORACIC_SPINE_2_VIEWS,
			XRAY_OF_LEFT_FOOT_2_VIEWS,
			XRAY_OF_RIGHT_FOOT_2_VIEWS,
			XRAY_OF_BILATERAL_FEET_2_VIEWS,
			XRAY_OF_LEFT_FOREARM_2_VIEWS,
			XRAY_OF_RIGHT_FOREARM_2_VIEWS,
			XRAY_OF_BILATERAL_FOREARMS_2_VIEWS,
			XRAY_OF_RIGHT_LOWER_LEG_2_VIEWS,
			XRAY_OF_LEFT_HAND_2_VIEWS,
			XRAY_OF_LEFT_LOWER_LEG_2_VIEWS,
			XRAY_OF_RIGHT_HAND_2_VIEWS,
			XRAY_OF_BILATERAL_HANDS_2_VIEWS,
			XRAY_OF_LEFT_HIP_2_VIEWS,
			XRAY_OF_RIGHT_HIP_2_VIEWS,
			XRAY_OF_BILATERAL_HIPS_2_VIEWS,
			XRAY_OF_THORACIC_AND_LUMBAR_SPINE_2_VIEWS,
			XRAY_OF_SPINE_1_VIEW,
			XRAY_OF_LEFT_UPPER_ARM_2_VIEWS,
			XRAY_OF_RIGHT_UPPER_ARM_2_VIEWS,
			XRAY_OF_SKULL_4_VIEWS,
			XRAY_OF_BILATERAL_UPPER_ARMS_2_VIEWS,
			XRAY_OF_SINUSES_3_VIEWS,
			XRAY_OF_RIGHT_SHOULDER_2_VIEWS,
			XRAY_OF_LEFT_SHOULDER_2_VIEWS,
			XRAY_OF_RIGHT_RIBS_2_VIEWS,
			XRAY_OF_LEFT_RIBS_2_VIEWS,
			XRAY_OF_PELVIS_1_VIEW,
			XRAY_OF_MANDIBLE_PANOREX_,
			XRAY_OF_LUMBAR_SPINE_2_OR_3_VIEWS,
			XRAY_OF_RIGHT_KNEE_1_OR_2_VIEWS,
			XRAY_OF_LEFT_KNEE_1_OR_2_VIEWS,
			XRAY_OF_BILATERAL_RIBS_2_VIEWS,
			XRAY_OF_BILATERAL_KNEES_2_VIEWS,
			XRAY_OF_CEREBROSPINAL_FLUID_SHUNT,
			XRAY_OF_BOTH_SACROILIAC_JOINTS,
			XRAY_OF_LEFT_STERNOCLAVICULAR_JOINT,
			XRAY_OF_RIGHT_STERNOCLAVICULAR_JOINT,
			PLAIN_XRAY_OF_LEFT_SACROILIAC_JOINT,
			PLAIN_XRAY_OF_RIGHT_SACROILIAC_JOINT,
			XRAY_OF_BILATERAL_WRISTS,
			ABDOMINAL_ERECT_XRAY,
			ORTHOPANTOMOGRAM,
			TIBIA_FIBULA_ANTEROPOSTERIOR_VIEW,
			XRAY_SCAPULA,
			XRAY_CHEST_PA_VIEW,
			XRAY_CHEST_LATERAL_VIEW,
			VENOGRAM_XRAY,
			THIGH_XRAY_LEFT,
			THIGH_XRAY_RIGHT,
			SELLA_XRAY,
			SACRAL_ILLIAC_JOINT_XRAY,
			POINTING_FINGER_X_RAY_LEFT,
			POINTING_FINGER_XRAY_RIGHT,
			OPTIC_FORAMEN_XRAY,
			ORBITS_XRAY,
			CENTRAL_SPINE_XRAY,
			ATHROGRAM_XRAY,
			...
			MAXILLA_XRAY,
			LIMB_XRAY,
			INTRAVENOUS_UROGRAPHY_IVU_XRAY,
			BARIUM_MEAL_XRAY,
			DENTAL_XRAY,
			SACRUM_XRAY,
			COCCYX_XRAY,
			MICTURATING_CYSTOURETHROGRAM_MCU_XRAY,
			ELBOW_JOINT_XRAY_LEFT,
			ELBOW_JOINT_XRAY_RIGHT,
			TIBIA__FIBULA_LEFT_XRAY,
			CHEST_LATERAL_XRAY,
			CHEST_RIBS_XRAY,
			WRIST_JOINT_XRAY_LEFT,
			WRIST_JOINT_XRAY_RIGHT,
			WRIST_XRAY_BOTH_HANDS,
			HAND_WRIST_XRAY_LEFT,
			HAND_WRIST_XRAY_RIGHT,
			FINGER_XRAY,
			HUMEROUS_SHOULDER_XRAY,
			HIP_LATERAL_XRAY,
			LUMBAR_SACRAL_XRAY,
			THORACOLUMBAR_SPINE_XRAY,
			FEMUR_HIP_XRAY,
			TIBIA__FIBULA_RIGHT_XRAY,
			FOOT_ANKLE_XRAY,
			TOE_XRAY,
			POST_NASAL_SPACE_XRAY,
			ABDOMEN_DEBUBIT_XRAY,
			ABDOMEN_LATERAL_XRAY,
			KIDNEY_URETER_AND_BLADDER_KUB_XRAY,
			THUMB_XRAY,
			TEMPOROMANDIBULAR_JOINT_TMJ_XRAY,
			SCAPULA_XRAY,
			NASAL_BONES_XRAY,
			ORTHOPANTOMOGRAM_OPG_XRAY,
			KNEE_JOINT_XRAY_RIGHT,
			KNEE_JOINT_XRAY_LEFT,
			RIGHT_JAW_XRAY,
			BILATERAL_BITE_WINGS_BBW,
			XRAY_POST_NASAL_SPACE
	)));
	...
	ULTRASOUND_HEPATIC,
	ECHOCARDIOGRAM,
	ULTRASONOGRAPHY_BY_TRANSRECTAL_APPROACH,
	ULTRASOUND_OF_BILATERAL_LOWER_EXTREMITY_VEINS,
	ULTRASOUND_OF_RIGHT_LOWER_EXTREMITY_VEIN,
	ULTRASOUND_OF_LEFT_LOWER_EXTREMITY_VEIN,
	ULTRASOUND_OF_EXTREMITY,
	ULTRASOUND_OF_PELVIS_TRANSVAGINAL,
	ULTRASOUND_OF_SCROTUM_AND_TESTICLE,
	ULTRASOUND_OF_ABDOMEN_AND_RETROPERITONEUM_LIMITED,
	ULTRASOUND_OF_ABDOMEN_AND_RETROPERITONEUM,
	ULTRASOUND_OF_PELVIS_LIMITED,
	ULTRASOUND_OF_PELVIS,
	ULTRASOUND_GUIDED_PARACENTESIS,
	ULTRASOUND_OF_HEAD_AND_NECK,
	ULTRASOUND_GUIDANCE_FOR_ASPIRATION_OF_PERICARDIAL_SPACE,
	ULTRASOUND_GUIDANCE_FOR_PERCUTANEOUS_DRAINAGE_OF_CAVITY,
	ULTRASOUND_OF_CHEST,
	ULTRASOUND_OF_LEFT_BREAST,
	ULTRASOUND_OF_RIGHT_BREAST,
	ULTRASOUND_OF_ABDOMEN_LIMITED,
	TRANSTHORACIC_ECHOCARDIOGRAM,
	ULTRASOUND_SCAN_OF_HEAD,
	FINE_NEEDLE_ASPIRATION_BIOPSY_OF_THYROID,
	ULTRASOUND_OF_THYROID,
	ULTRASOUND_OF_PROSTATE,
	ENDORECTAL_ULTRASOUND,
	DOPPLER_ULTRASOUND_OF_RENAL_ARTERY,
	DOPPLER_ULTRASOUND,
	RENAL_ULTRA_SOUND,
	FINGER_X__RAY_4TH_METATARSAL_RT_HAND,
	ULTRASOUND_LEFT_HAND_FINGER,
	NECK_ULTRA_SOUND,
	THYROID_ULTRA_SOUND,
	SCROTAL_ULTRA_SOUND,
	PROSTATE_ULTRA_SOUND,
	TESTICULAR_ULTRA_SOUND,
	DOPPLER_UPPER_LIMB_ARTERIAL,
	DOPPLER_LOWER_LIMB_ARTERIAL,
	DOPPLER_CAROTID,
	KNEE_ULTRA_SOUND,
	REGIONAL_ULTRASOUND,
	ULTRASOUND_GUIDED_FNA,
	ULTRASOUND_GUIDED_BIOPSY_SUPERFICIAL,
	ULTRASOUND_GUIDED_DEEP_BIOPSY,
	FAST_ULTRASOUND,
	INGUINAL_SCROTAL_ULTRASOUND,
	INGUINAL_SCAN,
	AXILLA_ULTRA_SOUND,
	KUB_PROSTATE_ULTRASOUND,
	KUB_ULTRASOUND,
	IMAGE_GUIDED_CHEMOPORT_INSERTION_ADULT,
	IMAGE_GUIDED_CHEMOPORT_INSERTION_PEADIATRIC,
	IMAGE_GUIDED_CVC_INSERTION,
	DOPPLER_UPPER_LIMB_VENOUS_LEFT,
	DOPPLER_LOWER_LIMB_VENOUS_RIGHT,
	ECHOGRAM,
	US_GUIDED_PIGTAIL_DRAINAGE_OF_A_CYST_LIVER_RENAL_OR_MESENTERIC,
	US_GUIDED_ASPIRATION_OF_A_CYST_OR_FLUID,
	US_GUIDED_SIMPLE_CYST_DRAINAGE_RENAL_LIVER_SPLEEN,
	US_GUIDED_TUMOUR_LOCALIZATION,
	MUSCULOSKELETAL_ULTRASOUND,
	DOPPLER_LOWER_LIMB_VENOUS_LEFT,
	CRANIAL_ULTRA_SOUND,
	ULTRASOUND_OF_BOTH_BREAST	)));
	...
	public static final String contrastEnhancedExaminationList = String.join(",",new ArrayList<>(Arrays.asList(
			FLUOROSCOPY_ESOPHAGUS,
			NUCLEAR_SCAN_TECHNETIUM_99MTC_SESTAMIBI,
			RETROGRADE_PYELOGRAM,
			FLUOROSCOPY,
			ANGIOGRAM,
			CHOLANGIOGRAM,
			VOIDING_URETHROCYSTOGRAPHY,
			INSERTION_OF_TUNNELED_DIALYSIS_CATHETER_USING_FLUOROSCOPIC_GUIDANCE,
			PERINEOGRAM,
			URETERAL_REFLUX_STUDY,
			CENTRAL_VENOUS_LINE_PROCEDURE_USING_FLUOROSCOPIC_GUIDANCE,
			INJECTION_OF_BLOOD_VESSEL_USING_FLUOROSCOPIC_GUIDANCE,
			LAPAROSCOPY_WITH_GUIDED_TRANSHEPATIC_CHOLANGIOGRAPHY,
			LAPAROSCOPY_WITH_GUIDED_TRANSHEPATIC_CHOLANGIOGRAPHY_AND_BIOPSY,
			NEPHROSTOMY_USING_FLUOROSCOPIC_GUIDANCE,
			RADIOGRAPHIC_IMAGING_NEPHROSTOMY,
			REPLACEMENT_OF_DIALYSIS_CATHETER_USING_FLUOROSCOPIC_GUIDANCE,
			REPLACEMENT_OF_NEPHROSTOMY_TUBE_USING_FLUOROSCOPIC_GUIDANCE,
			CAROTID_ARTERIOGRAPHY_UNILATERAL,
			CAROTID_ARTERIOGRAPHY_BILATERAL,
			CEREBRAL_FOUR_VESSEL_ANGIOGRAM,
			BARIUM_ENEMA,
			ANGIOGRAPHYAORTA,
			CONTRAST_MEDIA,
			ANGIOGRAPHYBRAIN,
			ANGIOGRAPHYEXTREMETIES,
			ANGIOGRAPHYPULMONARY_CHEST,
			HYSTEROSALPINGOGRAPHY,
			IMAGE_GUIDED_DIALYSIS_CATHETER_INSERTION,
			LOWER_UPPER_LIMB_ARTERIOGRAM_BILATERAL,
			LOWER_LIMB_UPPER_LIMB_ARTERIOGRAM_UNILATERAL,
			FLUSH_AORTOGRAM_RENAL_ARTERY_HEPATIC_WITH_EMBOLIZATION_MATERIAL_AND_MICROCATHET,
			INTERVENTIONAL_RADIOLOGY_IR_REVIEW_OF_TUBES,
			PERCUTANEOUS_TRANSHEPATIC_CHOLANGIOGRAPHY_PTC_WITH_BILIARY_DRAINAGE_TWO_TUBES,
			INTERNALIZATION_OF_BILIARY_TUBE_NO_TUBES_AVAILABLE,
			NEPHROSTOGRAM,
			GASTROGRAFIN_SWALLOW_XRAY,
			SINOGRAM,
			HYSTEROSALPINGOGRAM_HSG,
			MICTURATING_CYSTOURETHROGRAM_MCU
			)));
	...
	public static final String magneticResonanceImagingList = String.join(",",new ArrayList<>(Arrays.asList(
			...
			MAGNETIC_RESONANCE_IMAGING_OF_BRAIN_FUNCTIONAL,
			MAGNETIC_RESONANCE_IMAGING_OF_ABDOMEN_WITHOUT_CONTRAST,
			MAGNETIC_RESONANCE_IMAGING_OF_ABDOMEN_WITH_CONTRAST,
			MAGNETIC_RESONANCE_IMAGING_MRI_MODALITY,
			MAGNETIC_RESONANCE_IMAGING_OF_THORACOLUMBAR_SPINE,
			MAGNETIC_RESONANCE_IMAGING_OF_LUMBOSACRAL_SPINE,
			MAGNETIC_RESONANCE_IMAGING_OF_CERVICAL_SPINE,
			MAGNETIC_RESONANCE_IMAGING_OF_BREAST,
			MRI_HEAD_BRAIN_WR,
			MRI_HEAD_BRAIN_WITHOUT_R,
			MRI_KNEE_WR,
			MRI_CERVICAL_SPINE_WR,
			MRI_THORACIC_SPINE_WR,
			MRI_LUMBAR_SPINE_WR
			)));
	...
	public static final String computerizedTomographyList = String.join(",",new ArrayList<>(Arrays.asList(
			COMPUTED_TOMOGRAPHY_SCAN_HEAD,
			POSITRON_EMISSION_TOMOGRAPHY_SCAN,
			ICTAL_BRAIN_SINGLE_PHOTON_EMISSION_COMPUTED_TOMOGRAPHY_SPECT_,
			INTERICTAL_BRAIN_SINGLE_PHOTON_EMISSION_COMPUTED_TOMOGRAPHY_SPECT_,
			COMPUTED_TOMOGRAPHY_OF_ABDOMEN_AND_PELVIS_WITHOUT_CONTRAST,
			CT_SCAN_PELVIS,
			CT_SCAN_CHEST,
			COMPUTED_TOMOGRAPHY_OF_BILATERAL_LOWER_EXTREMITIES_WITHOUT_CONTRAST,
			COMPUTERIZED_TOMOGRAPHY_OF_RIGHT_UPPER_EXTREMITY_WITHOUT_CONTRAST,
			COMPUTERIZED_TOMOGRAPHY_OF_LEFT_UPPER_EXTREMITY_WITHOUT_CONTRAST,
			COMPUTERIZED_TOMOGRAPHY_OF_RIGHT_UPPER_EXTREMITY_WITH_IV_CONTRAST,
			COMPUTERIZED_TOMOGRAPHY_OF_LEFT_UPPER_EXTREMITY_WITH_IV_CONTRAST,
			COMPUTERIZED_TOMOGRAPHY_OF_FACIAL_BONES_AND_MAXILLA_WITHOUT_CONTRAST,
			COMPUTERIZED_TOMOGRAPHY_OF_RIGHT_LOWER_EXTREMITY_WITHOUT_CONTRAST,
			COMPUTERIZED_TOMOGRAPHY_OF_LEFT_LOWER_EXTREMITY_WITHOUT_CONTRAST,
			COMPUTERIZED_TOMOGRAPHY_OF_LUMBAR_SPINE_WITHOUT_CONTRAST,
			COMPUTERIZED_TOMOGRAPHY_OF_CERVICAL_SPINE_WITHOUT_CONTRAST,
			COMPUTED_TOMOGRAPHY_OF_BILATERAL_LOWER_EXTREMITIES_WITH_IV_CONTRAST,
			COMPUTED_TOMOGRAPHY_OF_CERVICAL_SPINE_WITH_INTRAVENOUS_CONTRAST,
			COMPUTED_TOMOGRAPHY_OF_CHEST_WITH_INTRAVENOUS_CONTRAST,
			COMPUTED_TOMOGRAPHY_OF_HEAD_WITH_INTRAVENOUS_CONTRAST,
			COMPUTED_TOMOGRAPHY_OF_LUMBAR_SPINE_WITH_INTRAVENOUS_CONTRAST,
			COMPUTED_TOMOGRAPHY_OF_RIGHT_LOWER_EXTREMITY_WITH_INTRAVENOUS_CONTRAST,
			COMPUTED_TOMOGRAPHY_OF_LEFT_LOWER_EXTREMITY_WITH_INTRAVENOUS_CONTRAST,
			COMPUTED_TOMOGRAPHY_OF_FACIAL_BONES_AND_MAXILLA_WITH_INTRAVENOUS_CONTRAST,
			COMPUTED_TOMOGRAPHY_OF_NECK_WITH_INTRAVENOUS_CONTRAST,
			COMPUTED_TOMOGRAPHY_OF_THORACIC_SPINE_WITH_INTRAVENOUS_CONTRAST,
			COMPUTED_TOMOGRAPHY_OF_ABDOMEN_AND_PELVIS_WITH_INTRAVENOUS_CONTRAST,
			COMPUTED_TOMOGRAPHY_OF_ABDOMEN_WITH_CONTRAST,
			COMPUTED_TOMOGRAPHY_OF_ABDOMEN_WITHOUT_CONTRAST,
			COMPUTED_TOMOGRAPHY_OF_CHEST_AND_ABDOMEN_WITHOUT_IV_CONTRAST,
			COMPUTED_TOMOGRAPHY_OF_CHEST_ABDOMEN_AND_PELVIS_WITHOUT_IV_CONTRAST,
			COMPUTED_TOMOGRAPHY_OF_CHEST_AND_ABDOMEN_WITH_IV_CONTRAST,
			COMPUTED_TOMOGRAPHY_OF_CHEST_ABDOMEN_AND_PELVIS_WITH_IV_CONTRAST,
			NEPHROSTOMY_USING_COMPUTED_TOMOGRAPHY_GUIDANCE,
			COMPUTED_TOMOGRAPHY_OF_HEART,
			COMPUTED_TOMOGRAPHY_OF_KNEE,
			COMPUTED_TOMOGRAPHY_OF_FEMUR,
			COMPUTED_TOMOGRAPHY_OF_HIP,
			COMPUTED_TOMOGRAPHY_OF_ORBITS_WITH_CONTRAST,
			COMPUTED_TOMOGRAPHY_OF_ORBITS_WITHOUT_CONTRAST,
			CT_SCANS_WITHOUT_CONTRAST_CHEST,
			COMPUTED_TOMOGRAPHY_OF_BRAIN_WITHOUT_CONTRAST,
			COMPUTED_TOMOGRAPHY_OF_CHEST_WITHOUT_CONTRAST,
			COMPUTED_TOMOGRAPHY_IVU_WITHOUT_CONTRAST,
			COMPUTED_TOMOGRAPHY_OF_NECK_WITHOUT_CONTRAST,
			COMPUTED_TOMOGRAPHY_WITHOUT_CONTRAST_PELVIMETRY,
			CT_PARANASAL_SINUSES,
			CT_ANGIOGRAM_WR,
			CT_BRAIN_ANGIOGRAM_WR,
			CT_EXTREMITIES_WR,
			CT_GUIDED_ABCESS_DRAINAGE_WR,
			CT_GUIDED_BIOPSY_LUNG_BIOPSY_WR,
			CT_GUIDED_BONE_BIOPSY_WR,
			CT_SCAN_ANKLE_WR,
			CT_SCAN_CERVICAL_SPINE_WR,
			CT_SCAN_CHEST_WITH_CONTRAST_WR,
			CT_SCAN_HEAD_BRAIN_WR,
			CT_SCAN_HIP_WR,
			CT_SCAN_KNEE_WR,
			CT_SCAN_LUMBER_SPINE_WR,
			CT_SCAN_NECK_WITH_CONTRAST_WR,
			CT_SCAN_PELVIC_TRAUMA_WR,
			CT_SCAN_PELVIC_WITH_CONTRAST_WR,
			CT_SCAN_PSN_WR,
			CT_SCAN_SHOULDER_WR,
			CT_SCAN_THORACIC_SPINE_WR,
			CT_SCAN_UROGRAM_WR,
			CT_SCAN_WRIST_WR,
			HIGH_RESOLUTION_COMPUTED_TOMOGRAPHY_HRCT_CHEST_SCAN
	)));
	...
	public static final String obstetricUltrasoundList = String.join(",",new ArrayList<>(Arrays.asList(
			OBSTETRIC_ULTRASOUND,ULTRASOUND_OBSTETRIC_DOPPLER
	)));
