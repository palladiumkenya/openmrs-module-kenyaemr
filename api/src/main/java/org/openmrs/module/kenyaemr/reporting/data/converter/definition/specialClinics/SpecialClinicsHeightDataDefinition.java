...
public class SpecialClinicsHeightDataDefinition extends BaseDataDefinition implements EncounterDataDefinition {
     ...
     * Default Constructor
     */
    public SpecialClinicsHeightDataDefinition() {
        super();
    }
     ...
     */
    public SpecialClinicsHeightDataDefinition(String name) {
        super(name);
    }
