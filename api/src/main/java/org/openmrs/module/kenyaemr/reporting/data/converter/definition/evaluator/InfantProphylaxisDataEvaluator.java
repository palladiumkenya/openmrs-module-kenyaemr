...
/**
 * Evaluates HEI infant prophylaxis
 */
@Handler(supports= InfantProphylaxisDataDefinition.class, order=50)
public class InfantProphylaxisDataEvaluator implements PersonDataEvaluator {
