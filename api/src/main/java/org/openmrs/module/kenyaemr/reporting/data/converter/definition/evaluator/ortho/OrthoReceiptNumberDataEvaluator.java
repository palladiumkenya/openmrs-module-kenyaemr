...
import org.openmrs.module.kenyaemr.reporting.data.converter.definition.ortho.OrthoUnderlyingConditionDataDefinition;
...
public class OrthoReceiptNumberDataEvaluator implements EncounterDataEvaluator {
    ...
    public EvaluatedEncounterData evaluate(EncounterDataDefinition definition, EvaluationContext context) throws EvaluationException {
        ...
        String qry = "select v.encounter_id,\n" +
                "(case v.underlying_condition when 1065 then 'Yes' when 1066 then 'No' else '' end) as underlying_condition\n" +
