 ...
 * OPD Register
 */
@Handler(supports= SpecialClinicsCadreDataDefinition.class, order=50)
public class SpecialClinicsCadreDataEvaluator implements EncounterDataEvaluator {
    ...
    public EvaluatedEncounterData evaluate(EncounterDataDefinition definition, EvaluationContext context) throws EvaluationException {
        ...
        SpecialClinicsCadreDataDefinition cohortDefinition = (SpecialClinicsCadreDataDefinition) definition;
