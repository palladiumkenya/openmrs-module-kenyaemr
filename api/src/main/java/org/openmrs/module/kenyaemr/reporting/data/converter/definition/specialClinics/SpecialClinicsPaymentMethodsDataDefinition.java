...
public class SpecialClinicsPaymentMethodsDataDefinition extends BaseDataDefinition implements EncounterDataDefinition {
     ...
     * Default Constructor
     */
    public SpecialClinicsPaymentMethodsDataDefinition() {
        super();
    }
     ...
     */
    public SpecialClinicsPaymentMethodsDataDefinition(String name) {
        super(name);
    }
