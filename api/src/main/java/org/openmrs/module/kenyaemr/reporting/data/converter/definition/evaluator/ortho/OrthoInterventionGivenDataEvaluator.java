...
import org.openmrs.module.kenyaemr.reporting.data.converter.definition.ortho.OrthoInterventionGivenDataDefinition;
 ...
 *
 */
@Handler(supports= OrthoInterventionGivenDataDefinition.class, order=50)
public class OrthoInterventionGivenDataEvaluator implements EncounterDataEvaluator {
    ...
    public EvaluatedEncounterData evaluate(EncounterDataDefinition definition, EvaluationContext context) throws EvaluationException {
        ...
        String qry = "select v.encounter_id,\n" +
                ...
                "            when 5622 then 'Others' else '' end) as intervention_given\n" +
