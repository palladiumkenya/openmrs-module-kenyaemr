...
public class SpecialClinicsSeroStatusDataDefinition extends BaseDataDefinition implements EncounterDataDefinition {
     ...
     * Default Constructor
     */
    public SpecialClinicsSeroStatusDataDefinition() {
        super();
    }
     ...
     */
    public SpecialClinicsSeroStatusDataDefinition(String name) {
        super(name);
    }
