 ...
 * OPD Register
 */
@Handler(supports= SpecialClinicsReferralStatusDataDefinition.class, order=50)
public class SpecialClinicsReferralStatusDataEvaluator implements EncounterDataEvaluator {
    ...
    public EvaluatedEncounterData evaluate(EncounterDataDefinition definition, EvaluationContext context) throws EvaluationException {
        ...
        SpecialClinicsReferralStatusDataDefinition cohortDefinition = (SpecialClinicsReferralStatusDataDefinition) definition;
        String specialClinic = cohortDefinition.getSpecialClinic();

        String qry = "select v.encounter_id,\n" +
                "(case v.referral_status when 5485 then 'Refer for in-patient care' when 164407 then 'Referral for other clinics' when 163316 then 'Referral for livelihood support' when 159492 then 'Transferred Out' else '' end) as referral_status\n" +
