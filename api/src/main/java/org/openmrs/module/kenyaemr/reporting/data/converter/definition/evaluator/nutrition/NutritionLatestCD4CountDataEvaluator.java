...
import org.openmrs.module.kenyaemr.reporting.data.converter.definition.nutrition.NutritionLatestCD4CountDataDefinition;
 ...
 *
 */
@Handler(supports= NutritionLatestCD4CountDataDefinition.class, order=50)
public class NutritionLatestCD4CountDataEvaluator implements EncounterDataEvaluator {
