...
public class SpecialClinicsVisitTypeDataDefinition extends BaseDataDefinition implements EncounterDataDefinition {
     ...
     * Default Constructor
     */
    public SpecialClinicsVisitTypeDataDefinition() {
        super();
    }
     ...
     */
    public SpecialClinicsVisitTypeDataDefinition(String name) {
        super(name);
    }
