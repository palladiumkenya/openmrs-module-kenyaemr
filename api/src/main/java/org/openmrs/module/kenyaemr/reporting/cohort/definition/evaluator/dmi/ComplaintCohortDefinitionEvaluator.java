 ...
 */
@Handler(supports = { ComplaintCohortDefinition.class })
public class ComplaintCohortDefinitionEvaluator implements EncounterQueryEvaluator {
	...
	public EncounterQueryResult evaluate(EncounterQuery encounterQuery, EvaluationContext context) throws EvaluationException {
		...
		String qry = "SELECT le.encounter_id from kenyaemr_etl.etl_allergy_chronic_illness le\n" +
