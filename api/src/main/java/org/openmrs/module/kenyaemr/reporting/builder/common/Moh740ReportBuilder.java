...
//        dsd.addColumn("Pre-existing HTN", "", ReportUtils.map(Moh740Indicator.preExistingHTN(), indParams), "");
        ...
        EmrReportingUtils.addRow(dsd,"No. diagnosed for gestational diabetes melitus", "No. diagnosed for gestational diabetes melitus", ReportUtils.map(Moh740Indicator.diabetesGestational(), indParams), all_indicators, Arrays.asList("02", "03"));
