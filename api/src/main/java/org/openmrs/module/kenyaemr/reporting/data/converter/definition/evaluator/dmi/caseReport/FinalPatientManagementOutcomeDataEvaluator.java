 ...
 */
@Handler(supports= FinalPatientManagementOutcomeDataDefinition.class, order=50)
public class FinalPatientManagementOutcomeDataEvaluator implements VisitDataEvaluator {
    ...
    public EvaluatedVisitData evaluate(VisitDataDefinition definition, EvaluationContext context) throws EvaluationException {
        ...
        String qry = "select e.visit_id,\n" +
                "       case e.patient_outcome\n" +
                "           when 160429 then \"Released Home\"\n" +
                "           when 1654 then \"Admit\"\n" +
                "           when 1693 then \"Referral\"\n" +
                "           when 159 then \"Deceased\" end as final_outcome\n" +
