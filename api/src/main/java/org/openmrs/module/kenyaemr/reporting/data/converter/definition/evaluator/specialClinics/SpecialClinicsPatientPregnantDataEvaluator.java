 ...
 * OPD Register
 */
@Handler(supports= SpecialClinicsPatientPregnantDataDefinition.class, order=50)
public class SpecialClinicsPatientPregnantDataEvaluator implements EncounterDataEvaluator {
    ...
    public EvaluatedEncounterData evaluate(EncounterDataDefinition definition, EvaluationContext context) throws EvaluationException {
        ...
        SpecialClinicsPatientPregnantDataDefinition cohortDefinition = (SpecialClinicsPatientPregnantDataDefinition) definition;
        String specialClinic = cohortDefinition.getSpecialClinic();

        String qry = "select v.encounter_id,\n" +
                "(case v.patient_pregnant when 1065 then 'Yes' when 1066 then 'No' else '' end) as patient_pregnant\n" +
