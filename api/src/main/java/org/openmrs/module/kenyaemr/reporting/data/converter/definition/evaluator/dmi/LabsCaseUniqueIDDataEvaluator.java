...
@Handler(supports= LabsCaseUniqueIDDataDefinition.class, order=50)
public class LabsCaseUniqueIDDataEvaluator implements EncounterDataEvaluator {
    ...
    public EvaluatedEncounterData evaluate(EncounterDataDefinition definition, EvaluationContext context) throws EvaluationException {
        ...
        String qry = "SELECT le.encounter_id, le.visit_id FROM kenyaemr_etl.etl_laboratory_extract le\n" +
