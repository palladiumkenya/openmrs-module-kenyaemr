...
public class SpecialClinicsReferredFromDataDefinition extends BaseDataDefinition implements EncounterDataDefinition {
     ...
     * Default Constructor
     */
    public SpecialClinicsReferredFromDataDefinition() {
        super();
    }
     ...
     */
    public SpecialClinicsReferredFromDataDefinition(String name) {
        super(name);
    }
