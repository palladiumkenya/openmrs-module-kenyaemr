...
public class SpecialClinicsCriteriaForAdmissionDataDefinition extends BaseDataDefinition implements EncounterDataDefinition {
     ...
     * Default Constructor
     */
    public SpecialClinicsCriteriaForAdmissionDataDefinition() {
        super();
    }
     ...
     */
    public SpecialClinicsCriteriaForAdmissionDataDefinition(String name) {
        super(name);
    }
