...
public class SpecialClinicsLinkedToOVCDataDefinition extends BaseDataDefinition implements EncounterDataDefinition {
     ...
     * Default Constructor
     */
    public SpecialClinicsLinkedToOVCDataDefinition() {
        super();
    }
     ...
     */
    public SpecialClinicsLinkedToOVCDataDefinition(String name) {
        super(name);
    }
