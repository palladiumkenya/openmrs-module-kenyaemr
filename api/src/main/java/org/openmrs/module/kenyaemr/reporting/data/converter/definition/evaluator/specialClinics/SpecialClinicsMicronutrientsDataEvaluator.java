 ...
 * OPD Register
 */
@Handler(supports= SpecialClinicsMicronutrientsDataDefinition.class, order=50)
public class SpecialClinicsMicronutrientsDataEvaluator implements EncounterDataEvaluator {
    ...
    public EvaluatedEncounterData evaluate(EncounterDataDefinition definition, EvaluationContext context) throws EvaluationException {
        ...
        SpecialClinicsMicronutrientsDataDefinition cohortDefinition = (SpecialClinicsMicronutrientsDataDefinition) definition;
