...
/**
 * Evaluates Specimen Type
 * OPD Lab Register
 */
@Handler(supports= OPDSpecimenTypeDataDefinition.class, order=50)
public class OPDSpecimenTypeDataEvaluator implements EncounterDataEvaluator {
