...
/**
 */
@Handler(supports= SpecialClinicsHeightDataDefinition.class, order=50)
public class SpecialClinicsHeightDataEvaluator implements EncounterDataEvaluator {
    ...
    public EvaluatedEncounterData evaluate(EncounterDataDefinition definition, EvaluationContext context) throws EvaluationException {
        ...
        SpecialClinicsHeightDataDefinition cohortDefinition = (SpecialClinicsHeightDataDefinition) definition;
        String specialClinic = cohortDefinition.getSpecialClinic();

        String qry = "select c.encounter_id, t.height\n" +
