...
public class SpecialClinicsPostnatalFeedingDataDefinition extends BaseDataDefinition implements EncounterDataDefinition {
     ...
     * Default Constructor
     */
    public SpecialClinicsPostnatalFeedingDataDefinition() {
        super();
    }
     ...
     */
    public SpecialClinicsPostnatalFeedingDataDefinition(String name) {
        super(name);
    }
