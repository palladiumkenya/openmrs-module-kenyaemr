...
public class SpecialClinicsDrugOrderDataDefinition extends BaseDataDefinition implements EncounterDataDefinition {
     ...
     * Default Constructor
     */
    public SpecialClinicsDrugOrderDataDefinition() {
        super();
    }
     ...
     */
    public SpecialClinicsDrugOrderDataDefinition(String name) {
        super(name);
    }
