...
import org.openmrs.module.kenyaemr.reporting.data.converter.definition.occupation.PaymentMethodDataDefinition;
...
/**
 */
@Handler(supports= PaymentMethodDataDefinition.class, order=50)
public class PaymentMethodDataEvaluator implements EncounterDataEvaluator {
