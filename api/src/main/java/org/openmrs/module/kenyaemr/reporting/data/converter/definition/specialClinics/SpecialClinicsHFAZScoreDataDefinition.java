...
public class SpecialClinicsHFAZScoreDataDefinition extends BaseDataDefinition implements EncounterDataDefinition {
     ...
     * Default Constructor
     */
    public SpecialClinicsHFAZScoreDataDefinition() {
        super();
    }
     ...
     */
    public SpecialClinicsHFAZScoreDataDefinition(String name) {
        super(name);
    }
