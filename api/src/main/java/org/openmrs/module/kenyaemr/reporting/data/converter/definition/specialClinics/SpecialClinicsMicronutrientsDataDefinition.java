...
public class SpecialClinicsMicronutrientsDataDefinition extends BaseDataDefinition implements EncounterDataDefinition {
     ...
     * Default Constructor
     */
    public SpecialClinicsMicronutrientsDataDefinition() {
        super();
    }
     ...
     */
    public SpecialClinicsMicronutrientsDataDefinition(String name) {
        super(name);
    }
