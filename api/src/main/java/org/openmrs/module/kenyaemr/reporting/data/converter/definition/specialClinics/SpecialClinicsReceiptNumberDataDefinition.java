...
public class SpecialClinicsReceiptNumberDataDefinition extends BaseDataDefinition implements EncounterDataDefinition {
     ...
     * Default Constructor
     */
    public SpecialClinicsReceiptNumberDataDefinition() {
        super();
    }
     ...
     */
    public SpecialClinicsReceiptNumberDataDefinition(String name) {
        super(name);
    }
