...
/**
 * Evaluates Patient Statuses
 */
@Handler(supports= PatientStatusDataDefinition.class, order=50)
public class PatientStatusDefinitionEvaluator implements PersonDataEvaluator {
    ...
    public EvaluatedPersonData evaluate(PersonDataDefinition definition, EvaluationContext context) throws EvaluationException {
        ...
        String qry = "select fdr.patient_id, if(disc.outcome is null,\"Active\",disc.outcome) as outcome\n" +
                "        from  (SELECT patient_id  FROM kenyaemr_etl.etl_drug_event WHERE program=\"HIV\" ) fdr\n" +
                "        left join (SELECT patient_id, mid(max(concat(visit_date,(case discontinuation_reason\n" +
