...
public class CommonMetadata extends AbstractMetadataBundle {
	...
	public static final class _EncounterType {
		...
		public static final String SARI_SCREENING = "c8893e6a-f681-4412-b8f6-f02528ffd03b" ;
		public static final String ILI_SCREENING = "97f73bf8-e087-4cfb-b811-b3df8e92d4cf" ;
	}
	...
	public static final class _Form {
		...
		public static final String SARI_SCREENING = Metadata.Form.SARI_SCREENING;
		public static final String ILI_SCREENING = Metadata.Form.ILI_SCREENING;
	...
	public void install() {
		...
		install(encounterType("SARI Screening", "Collection of limited SARI data prior to a more thorough examination", _EncounterType.SARI_SCREENING));
		install(encounterType("ILI Screening", "Collection of limited SARI data prior to a more thorough examination", _EncounterType.ILI_SCREENING));
		...
		install(form("SARI Screening", null, _EncounterType.SARI_SCREENING, "1", _Form.SARI_SCREENING));
		install(form("ILI Screening", null, _EncounterType.ILI_SCREENING, "1", _Form.ILI_SCREENING));
