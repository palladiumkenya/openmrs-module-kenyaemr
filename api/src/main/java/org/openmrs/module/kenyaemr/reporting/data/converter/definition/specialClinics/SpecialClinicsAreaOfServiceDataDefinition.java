...
public class SpecialClinicsAreaOfServiceDataDefinition extends BaseDataDefinition implements EncounterDataDefinition {
     ...
     * Default Constructor
     */
    public SpecialClinicsAreaOfServiceDataDefinition() {
        super();
    }
     ...
     */
    public SpecialClinicsAreaOfServiceDataDefinition(String name) {
        super(name);
    }
