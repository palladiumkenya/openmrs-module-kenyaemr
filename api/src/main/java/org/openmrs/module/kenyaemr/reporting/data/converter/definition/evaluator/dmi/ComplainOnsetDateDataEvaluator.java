...
@Handler(supports= ComplainOnsetDateDataDefinition.class, order=50)
public class ComplainOnsetDateDataEvaluator implements EncounterDataEvaluator {
    ...
    public EvaluatedEncounterData evaluate(EncounterDataDefinition definition, EvaluationContext context) throws EvaluationException {
        ...
        String qry = "select   v.encounter_id,   a.visit_date from kenyaemr_etl.etl_clinical_encounter v\n" +
