...
public class SpecialClinicsNutritionalStatusDataDefinition extends BaseDataDefinition implements EncounterDataDefinition {
     ...
     * Default Constructor
     */
    public SpecialClinicsNutritionalStatusDataDefinition() {
        super();
    }
     ...
     */
    public SpecialClinicsNutritionalStatusDataDefinition(String name) {
        super(name);
    }
