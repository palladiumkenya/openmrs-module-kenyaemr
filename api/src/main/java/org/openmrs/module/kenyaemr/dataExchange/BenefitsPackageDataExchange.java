...
public class BenefitsPackageDataExchange {
    ...
    private static Map<String, String> extractBenefitsPackage(String benefitsPackage) {
    ...
    public static boolean saveBenefitsPackage() {
        try {
            ...
            if (responseEntity.getStatusCode().is2xxSuccessful() && responseBody != null) {
                ...
                if (benefitsPackage.get("shaBenefitsPackage").equals("--")) {
                    System.err.println("No valid benefits package found in the response.");
                    return false;
                }
