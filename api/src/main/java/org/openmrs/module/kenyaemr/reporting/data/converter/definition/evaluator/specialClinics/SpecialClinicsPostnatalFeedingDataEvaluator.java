 ...
 * OPD Register
 */
@Handler(supports= SpecialClinicsPostnatalFeedingDataDefinition.class, order=50)
public class SpecialClinicsPostnatalFeedingDataEvaluator implements EncounterDataEvaluator {
    ...
    public EvaluatedEncounterData evaluate(EncounterDataDefinition definition, EvaluationContext context) throws EvaluationException {
        ...
        SpecialClinicsPostnatalFeedingDataDefinition cohortDefinition = (SpecialClinicsPostnatalFeedingDataDefinition) definition;
