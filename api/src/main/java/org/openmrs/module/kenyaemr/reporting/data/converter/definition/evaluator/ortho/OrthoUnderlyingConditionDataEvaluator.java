...
import org.openmrs.module.kenyaemr.reporting.data.converter.definition.ortho.OrthoReceiptNumberDataDefinition;
...
public class OrthoUnderlyingConditionDataEvaluator implements EncounterDataEvaluator {
    ...
    public EvaluatedEncounterData evaluate(EncounterDataDefinition definition, EvaluationContext context) throws EvaluationException {
        ...
        String qry = "SELECT v.encounter_id, " +
                ...
                "LEFT JOIN openmrs.cashier_bill t ON v.patient_id = t.patient_id " +
