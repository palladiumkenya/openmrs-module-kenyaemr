 ...
 * OPD Register
 */
@Handler(supports= SpecialClinicsAnaemicLevelDataDefinition.class, order=50)
public class SpecialClinicsAnaemicLevelDataEvaluator implements EncounterDataEvaluator {
    ...
    public EvaluatedEncounterData evaluate(EncounterDataDefinition definition, EvaluationContext context) throws EvaluationException {
        ...
        SpecialClinicsAnaemicLevelDataDefinition cohortDefinition = (SpecialClinicsAnaemicLevelDataDefinition) definition;
