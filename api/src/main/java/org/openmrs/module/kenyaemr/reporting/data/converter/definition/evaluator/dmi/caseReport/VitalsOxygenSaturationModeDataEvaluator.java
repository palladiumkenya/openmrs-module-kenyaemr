...
@Handler(supports = VitalsOxygenSaturationModeDataDefinition.class, order = 50)
public class VitalsOxygenSaturationModeDataEvaluator implements VisitDataEvaluator {
    ...
    public EvaluatedVisitData evaluate(VisitDataDefinition definition, EvaluationContext context) throws EvaluationException {
        ...
        String qry = "select t.visit_id,\n" +
                "       case t.oxygen_saturation_collection_mode\n" +
                "           when 162735 then 'Room air'\n" +
                "           when 162738 then 'On supplemental oxygen' end as oxygen_saturation_mode\n" +
