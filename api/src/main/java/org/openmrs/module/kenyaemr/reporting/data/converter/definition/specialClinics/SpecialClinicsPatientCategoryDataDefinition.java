...
public class SpecialClinicsPatientCategoryDataDefinition extends BaseDataDefinition implements EncounterDataDefinition {
     ...
     * Default Constructor
     */
    public SpecialClinicsPatientCategoryDataDefinition() {
        super();
    }
     ...
     */
    public SpecialClinicsPatientCategoryDataDefinition(String name) {
        super(name);
    }
