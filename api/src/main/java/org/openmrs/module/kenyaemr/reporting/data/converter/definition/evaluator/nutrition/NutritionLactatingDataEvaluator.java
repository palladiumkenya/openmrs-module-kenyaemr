...
import org.openmrs.module.kenyaemr.reporting.data.converter.definition.nutrition.NutritionLactatingDataDefinition;
...
/**
 * Nutrition Visit type for children under 15years
 */
@Handler(supports= NutritionLactatingDataDefinition.class, order=50)
public class NutritionLactatingDataEvaluator implements EncounterDataEvaluator {
