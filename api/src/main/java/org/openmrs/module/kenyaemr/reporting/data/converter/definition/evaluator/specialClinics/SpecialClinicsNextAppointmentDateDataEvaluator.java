...
/**
     * Evaluates next appointment date
 */
@Handler(supports= SpecialClinicsNextAppointmentDateDataDefinition.class, order=50)
public class SpecialClinicsNextAppointmentDateDataEvaluator implements EncounterDataEvaluator {
    ...
    public EvaluatedEncounterData evaluate(EncounterDataDefinition definition, EvaluationContext context) throws EvaluationException {
        ...
        SpecialClinicsNextAppointmentDateDataDefinition cohortDefinition = (SpecialClinicsNextAppointmentDateDataDefinition) definition;
        String specialClinic = cohortDefinition.getSpecialClinic();

        String qry = "select s.encounter_id, s.next_appointment_date\n" +
