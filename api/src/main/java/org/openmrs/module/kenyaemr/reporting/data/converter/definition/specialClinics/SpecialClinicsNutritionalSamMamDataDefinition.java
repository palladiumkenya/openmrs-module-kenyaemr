...
public class SpecialClinicsNutritionalSamMamDataDefinition extends BaseDataDefinition implements EncounterDataDefinition {
     ...
     * Default Constructor
     */
    public SpecialClinicsNutritionalSamMamDataDefinition() {
        super();
    }
     ...
     */
    public SpecialClinicsNutritionalSamMamDataDefinition(String name) {
        super(name);
    }
