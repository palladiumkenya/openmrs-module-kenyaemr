...
public class SpecialClinicsTypeOfAdmissionDataDefinition extends BaseDataDefinition implements EncounterDataDefinition {
     ...
     * Default Constructor
     */
    public SpecialClinicsTypeOfAdmissionDataDefinition() {
        super();
    }
     ...
     */
    public SpecialClinicsTypeOfAdmissionDataDefinition(String name) {
        super(name);
    }
