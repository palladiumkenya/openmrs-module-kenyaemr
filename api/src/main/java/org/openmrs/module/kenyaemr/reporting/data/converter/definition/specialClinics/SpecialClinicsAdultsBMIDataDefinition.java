...
public class SpecialClinicsAdultsBMIDataDefinition extends BaseDataDefinition implements EncounterDataDefinition {
     ...
     * Default Constructor
     */
    public SpecialClinicsAdultsBMIDataDefinition() {
        super();
    }
     ...
     */
    public SpecialClinicsAdultsBMIDataDefinition(String name) {
        super(name);
    }
