 ...
 * OPD Register
 */
@Handler(supports= SpecialClinicsSupplementalFoodsDataDefinition.class, order=50)
public class SpecialClinicsSupplementalFoodsDataEvaluator implements EncounterDataEvaluator {
    ...
    public EvaluatedEncounterData evaluate(EncounterDataDefinition definition, EvaluationContext context) throws EvaluationException {
        ...
        SpecialClinicsSupplementalFoodsDataDefinition cohortDefinition = (SpecialClinicsSupplementalFoodsDataDefinition) definition;
