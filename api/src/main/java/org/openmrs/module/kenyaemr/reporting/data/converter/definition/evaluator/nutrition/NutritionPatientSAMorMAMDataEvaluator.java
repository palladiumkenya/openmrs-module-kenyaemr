...
import org.openmrs.module.kenyaemr.reporting.data.converter.definition.nutrition.NutritionPatientSAMorMAMDataDefinition;
 ...
 *
 */
@Handler(supports= NutritionPatientSAMorMAMDataDefinition.class, order=50)
public class NutritionPatientSAMorMAMDataEvaluator implements EncounterDataEvaluator {
