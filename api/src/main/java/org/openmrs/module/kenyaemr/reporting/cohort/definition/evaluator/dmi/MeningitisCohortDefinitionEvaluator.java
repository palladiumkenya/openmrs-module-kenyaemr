...
import org.openmrs.module.kenyaemr.reporting.cohort.definition.dmi.MeningitisCohortDefinition;
...
/**
 * Evaluator for Meningitis Cohort
 */
@Handler(supports = { MeningitisCohortDefinition.class })
public class MeningitisCohortDefinitionEvaluator implements CohortDefinitionEvaluator {
	...
	public EvaluatedCohort evaluate(CohortDefinition cohortDefinition, EvaluationContext context) throws EvaluationException {
		...
		MeningitisCohortDefinition definition = (MeningitisCohortDefinition) cohortDefinition;
