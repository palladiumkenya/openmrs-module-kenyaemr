...
@Component
@Builds({"kenyaemr.specialClinics.report.moh416"})
public class MOH416ReportBuilder extends AbstractReportBuilder {
    public static final String ENC_DATE_FORMAT = "yyyy/MM/dd";
    public static final String DATE_FORMAT = "dd/MM/yyyy";
	private static final String SPECIAL_CLINIC = CommonMetadata._Form.OPHTHAMOLOGY_CLINICAL_FORM;
    ...
    protected DataSetDefinition datasetColumns() {
		...
		SpecialClinicsVisualAcuityDataDefinition specialClinicsVisualAcuityDataDefinition = new SpecialClinicsVisualAcuityDataDefinition();
		specialClinicsVisualAcuityDataDefinition.addParameter(new Parameter("endDate", "End Date", Date.class));
		specialClinicsVisualAcuityDataDefinition.addParameter(new Parameter("startDate", "Start Date", Date.class));
		specialClinicsVisualAcuityDataDefinition.setSpecialClinic(SPECIAL_CLINIC);
		...
		dsd.addColumn("Visual Acuity", specialClinicsVisualAcuityDataDefinition, paramMapping);
		dsd.addColumn("Disability Type", patientDisabilityTypeDataDefinition, paramMapping);
