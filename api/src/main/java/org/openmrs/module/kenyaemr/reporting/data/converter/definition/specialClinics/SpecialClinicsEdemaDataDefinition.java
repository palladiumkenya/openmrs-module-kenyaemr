...
public class SpecialClinicsEdemaDataDefinition extends BaseDataDefinition implements EncounterDataDefinition {
     ...
     * Default Constructor
     */
    public SpecialClinicsEdemaDataDefinition() {
        super();
    }
     ...
     */
    public SpecialClinicsEdemaDataDefinition(String name) {
        super(name);
    }
