 ...
 */
@Handler(supports= FacilityTransferToDataDefinition.class, order=50)

	public class FacilityTransferToCohortDefinitionEvaluator  implements PersonDataEvaluator {
