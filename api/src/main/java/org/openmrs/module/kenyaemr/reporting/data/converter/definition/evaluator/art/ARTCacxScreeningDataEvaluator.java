...
public class ARTCacxScreeningDataEvaluator implements PersonDataEvaluator {
    ...
    public EvaluatedPersonData evaluate(PersonDataDefinition definition, EvaluationContext context) throws EvaluationException {
        ...
        String qry = "SELECT hiv_subquery.patient_id,\n" +
                "CASE\n" +
                "WHEN hiv_subquery.hiv_screening_result = 'Yes' OR ccs.screened_for_cacx = 'Yes' THEN 'Yes'\n" +
                "ELSE 'No' END AS screening_result\n" +
                "FROM (SELECT f.patient_id,\n" +
                "CASE\n" +
                "WHEN MID(MAX(CONCAT(f.visit_date, CASE WHEN f.cacx_screening IS NOT NULL THEN 'Yes' ELSE 'No' END)),11) = 'Yes' THEN 'Yes'\n" +
                "ELSE 'No' END AS hiv_screening_result,\n" +
