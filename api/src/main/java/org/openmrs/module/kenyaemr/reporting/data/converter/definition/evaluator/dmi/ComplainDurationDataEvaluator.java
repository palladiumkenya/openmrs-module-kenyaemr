...
@Handler(supports= ComplainDurationDataDefinition.class, order=50)
public class ComplainDurationDataEvaluator implements EncounterDataEvaluator {
    ...
    public EvaluatedEncounterData evaluate(EncounterDataDefinition definition, EvaluationContext context) throws EvaluationException {
        ...
        String qry = "select   v.encounter_id,   a.complaint_duration from kenyaemr_etl.etl_clinical_encounter v\n" +
