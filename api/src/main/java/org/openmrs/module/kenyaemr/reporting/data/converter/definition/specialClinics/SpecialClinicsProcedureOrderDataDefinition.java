...
public class SpecialClinicsProcedureOrderDataDefinition extends BaseDataDefinition implements EncounterDataDefinition {
     ...
     * Default Constructor
     */
    public SpecialClinicsProcedureOrderDataDefinition() {
        super();
    }
     ...
     */
    public SpecialClinicsProcedureOrderDataDefinition(String name) {
        super(name);
    }
