...
@Handler(supports = VitalsCaseUniqueIdDataDefinition.class, order = 50)
public class VitalsCaseUniqueIdDataEvaluator implements VisitDataEvaluator {
    ...
    public EvaluatedVisitData evaluate(VisitDataDefinition definition, EvaluationContext context) throws EvaluationException {
        ...
        String qry = "select t.visit_id,t.visit_id\n" +
