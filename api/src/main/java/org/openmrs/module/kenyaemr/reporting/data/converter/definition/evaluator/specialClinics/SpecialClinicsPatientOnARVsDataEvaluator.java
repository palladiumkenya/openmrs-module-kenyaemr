 ...
 * OPD Register
 */
@Handler(supports= SpecialClinicsPatientOnARVsDataDefinition.class, order=50)
public class SpecialClinicsPatientOnARVsDataEvaluator implements EncounterDataEvaluator {
    ...
    public EvaluatedEncounterData evaluate(EncounterDataDefinition definition, EvaluationContext context) throws EvaluationException {
        ...
        SpecialClinicsPatientOnARVsDataDefinition cohortDefinition = (SpecialClinicsPatientOnARVsDataDefinition) definition;
        String specialClinic = cohortDefinition.getSpecialClinic();

        String qry = "select v.encounter_id,\n" +
                "(case v.patient_on_arv when 1065 then 'Yes' when 1066 then 'No' else '' end) as patient_on_arv\n" +
