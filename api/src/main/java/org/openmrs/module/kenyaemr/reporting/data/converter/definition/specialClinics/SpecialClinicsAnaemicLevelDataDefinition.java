...
public class SpecialClinicsAnaemicLevelDataDefinition extends BaseDataDefinition implements EncounterDataDefinition {
     ...
     * Default Constructor
     */
    public SpecialClinicsAnaemicLevelDataDefinition() {
        super();
    }
     ...
     */
    public SpecialClinicsAnaemicLevelDataDefinition(String name) {
        super(name);
    }
