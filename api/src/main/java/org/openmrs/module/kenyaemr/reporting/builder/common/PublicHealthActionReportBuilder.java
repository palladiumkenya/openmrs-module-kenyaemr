...
public class PublicHealthActionReportBuilder extends AbstractReportBuilder {
    ...
    protected DataSetDefinition publicHealthAction() {
        ...
        cohortDsd.addColumn("Clients eligible for cervical cancer screening", "", ReportUtils.map(publicHealthActionIndicatorLibrary.eligibleForCervicalCancerScreening(), "startDate=${startDate},endDate=${endDate}"), "");
