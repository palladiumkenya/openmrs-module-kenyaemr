...
public class PublicHealthActionReportBuilder extends AbstractReportBuilder {
    ...
    protected DataSetDefinition publicHealthAction() {
        ...
        cohortDsd.addColumn("Virally Unsuppressed without Enhanced Adherence Counselling", "", ReportUtils.map(publicHealthActionIndicatorLibrary.txCUrrUnsuppressedWithoutValidVL(), "startDate=${startDate},endDate=${endDate}"), "");
