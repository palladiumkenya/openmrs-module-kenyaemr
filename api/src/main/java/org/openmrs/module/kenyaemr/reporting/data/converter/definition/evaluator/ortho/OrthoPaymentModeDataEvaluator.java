...
import org.openmrs.module.kenyaemr.reporting.data.converter.definition.ortho.OrthoPaymentModeDataDefinition;
 ...
 *
 */
@Handler(supports= OrthoPaymentModeDataDefinition.class, order=50)
public class OrthoPaymentModeDataEvaluator implements EncounterDataEvaluator {
    ...
    public EvaluatedEncounterData evaluate(EncounterDataDefinition definition, EvaluationContext context) throws EvaluationException {
        ...
        String qry = "SELECT v.encounter_id, m.name AS payment_mode\n" +
