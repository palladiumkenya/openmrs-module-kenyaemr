 ...
 * OPD Register
 */
@Handler(supports= SpecialClinicsCriteriaForAdmissionDataDefinition.class, order=50)
public class SpecialClinicsCriteriaForAdmissionDataEvaluator implements EncounterDataEvaluator {
    ...
    public EvaluatedEncounterData evaluate(EncounterDataDefinition definition, EvaluationContext context) throws EvaluationException {
        ...
        SpecialClinicsCriteriaForAdmissionDataDefinition cohortDefinition = (SpecialClinicsCriteriaForAdmissionDataDefinition) definition;
