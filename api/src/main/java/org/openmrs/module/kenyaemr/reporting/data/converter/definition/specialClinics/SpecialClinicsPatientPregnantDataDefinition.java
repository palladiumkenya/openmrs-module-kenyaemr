...
public class SpecialClinicsPatientPregnantDataDefinition extends BaseDataDefinition implements EncounterDataDefinition {
     ...
     * Default Constructor
     */
    public SpecialClinicsPatientPregnantDataDefinition() {
        super();
    }
     ...
     */
    public SpecialClinicsPatientPregnantDataDefinition(String name) {
        super(name);
    }
