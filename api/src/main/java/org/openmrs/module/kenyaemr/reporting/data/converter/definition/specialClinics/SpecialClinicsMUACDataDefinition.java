...
public class SpecialClinicsMUACDataDefinition extends BaseDataDefinition implements EncounterDataDefinition {
     ...
     * Default Constructor
     */
    public SpecialClinicsMUACDataDefinition() {
        super();
    }
     ...
     */
    public SpecialClinicsMUACDataDefinition(String name) {
        super(name);
    }
