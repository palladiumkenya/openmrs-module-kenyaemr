...
public class SpecialClinicsBMIDataDefinition extends BaseDataDefinition implements EncounterDataDefinition {
     ...
     * Default Constructor
     */
    public SpecialClinicsBMIDataDefinition() {
        super();
    }
     ...
     */
    public SpecialClinicsBMIDataDefinition(String name) {
        super(name);
    }
