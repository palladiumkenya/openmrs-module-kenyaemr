...
public class SpecialClinicsMaternalNutritionDataDefinition extends BaseDataDefinition implements EncounterDataDefinition {
     ...
     * Default Constructor
     */
    public SpecialClinicsMaternalNutritionDataDefinition() {
        super();
    }
     ...
     */
    public SpecialClinicsMaternalNutritionDataDefinition(String name) {
        super(name);
    }
