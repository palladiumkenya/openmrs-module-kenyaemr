...
public class SpecialClinicsReferralStatusDataDefinition extends BaseDataDefinition implements EncounterDataDefinition {
     ...
     * Default Constructor
     */
    public SpecialClinicsReferralStatusDataDefinition() {
        super();
    }
     ...
     */
    public SpecialClinicsReferralStatusDataDefinition(String name) {
        super(name);
    }
