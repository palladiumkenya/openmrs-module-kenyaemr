...
import org.openmrs.module.kenyaemr.reporting.data.converter.definition.occupation.ReceiptDataDefinition;
...
/**
 */
@Handler(supports= ReceiptDataDefinition.class, order=50)
public class ReceiptDataEvaluator implements EncounterDataEvaluator {
