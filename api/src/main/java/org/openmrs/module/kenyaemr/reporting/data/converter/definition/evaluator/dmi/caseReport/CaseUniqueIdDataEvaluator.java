...
public class CaseUniqueIdDataEvaluator implements VisitDataEvaluator {
    ...
    public EvaluatedVisitData evaluate(VisitDataDefinition definition, EvaluationContext context) throws EvaluationException {
        ...
        String qry = "select v.visit_id,v.visit_id from openmrs.visit v where date(v.date_started) between date(:startDate) and date(:endDate) and v.voided = 0;";
