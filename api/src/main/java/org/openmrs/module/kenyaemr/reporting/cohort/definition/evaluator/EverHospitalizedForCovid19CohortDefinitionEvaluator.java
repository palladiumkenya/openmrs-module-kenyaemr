 ...
 */
@Handler(supports = {EverHospitalizedCovid19CohortDefinition.class})
public class EverHospitalizedForCovid19CohortDefinitionEvaluator implements CohortDefinitionEvaluator {
    ...
    public EvaluatedCohort evaluate(CohortDefinition cohortDefinition, EvaluationContext context) throws EvaluationException {
		...
		EverHospitalizedCovid19CohortDefinition definition = (EverHospitalizedCovid19CohortDefinition) cohortDefinition;
