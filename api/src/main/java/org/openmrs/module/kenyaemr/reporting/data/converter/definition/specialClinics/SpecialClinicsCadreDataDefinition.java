...
public class SpecialClinicsCadreDataDefinition extends BaseDataDefinition implements EncounterDataDefinition {
     ...
     * Default Constructor
     */
    public SpecialClinicsCadreDataDefinition() {
        super();
    }
     ...
     */
    public SpecialClinicsCadreDataDefinition(String name) {
        super(name);
    }
