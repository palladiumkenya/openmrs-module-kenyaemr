...
import org.openmrs.module.kenyaemr.reporting.data.converter.definition.ncd.NCDTreatmentSupporterDataDefinition;
...
@Component
@Handler(supports= NCDTreatmentSupporterDataDefinition.class, order=50)
public class NCDTreatmentSupporterDataEvaluator implements EncounterDataEvaluator {
    @Autowired
