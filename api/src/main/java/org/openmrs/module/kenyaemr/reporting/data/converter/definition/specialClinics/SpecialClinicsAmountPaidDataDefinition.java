...
public class SpecialClinicsAmountPaidDataDefinition extends BaseDataDefinition implements EncounterDataDefinition {
     ...
     * Default Constructor
     */
    public SpecialClinicsAmountPaidDataDefinition() {
        super();
    }
     ...
     */
    public SpecialClinicsAmountPaidDataDefinition(String name) {
        super(name);
    }
