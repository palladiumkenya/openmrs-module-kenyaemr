...
public class SpecialClinicsSymptomsDataDefinition extends BaseDataDefinition implements EncounterDataDefinition {
     ...
     * Default Constructor
     */
    public SpecialClinicsSymptomsDataDefinition() {
        super();
    }
     ...
     */
    public SpecialClinicsSymptomsDataDefinition(String name) {
        super(name);
    }
