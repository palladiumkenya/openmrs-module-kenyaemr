...
@SharedPage
public class EditPractitionerFormPageController {
    ...
    public String controller(@RequestParam(required = false,value = "appId") String appId,
        ...
        List<Encounter> encounters = Context.getEncounterService().getEncounters(new Patient(person.getId()), null, null, null, Collections.singleton(form), null, null, null, null, false);
        ...
        sb.append("&patientId=" + person.getId());
