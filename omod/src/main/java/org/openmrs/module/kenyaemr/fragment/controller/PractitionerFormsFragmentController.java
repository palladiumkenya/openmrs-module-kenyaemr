...
public class PractitionerFormsFragmentController {
    protected static final Log log = LogFactory.getLog(PractitionerFormsFragmentController.class);
...
//                           @FragmentParam("visit") Visit visit,
        ...
        descriptor.setTargetUuid(MchMetadata._Form.MCHMS_PRACTITIONER_EXPERIENCE);
        availableForms.add(ui.simplifyObject(descriptor.getTarget()));
        model.addAttribute("practitionerForms", availableForms);
