 ...
 */
public class MchpsEnrollmentSummaryFragmentController {
    ...
    public String controller(@FragmentParam("patientProgram") PatientProgram patientProgram,
        ...
        EncounterType mchSurvey = MetadataUtils.existing(EncounterType.class, MchMetadata._EncounterType.MCH_SURVEY);
