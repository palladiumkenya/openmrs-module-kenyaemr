<div class="ke-page-header">
	<div style="float: left; padding-right: 3px">
		<a href="/${ contextPath }/index.htm?<% if (config.context) { %>${ config.context }<% } %>">
			<img src="${ ui.resourceLink("kenyaemr", "images/logos/ethio.jpeg") }" width="48" height="48" />
		</a>
	</div>
	<div style="float: left">
		<span style="font-size: 24px;">${ ui.message("EthioEMR") }</span>
	...
	<div style="float: right; text-align: right">
		<img src="${ ui.resourceLink("kenyaemr", "images/logos/ethioemr.jpeg") }" width="200" height="48" />
	</div>
